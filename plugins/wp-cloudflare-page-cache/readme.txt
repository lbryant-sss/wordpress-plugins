...
- **Enhanced Defer JS functionality** with new  filter hook allowing developers to exclude specific scripts from being deferred, providing more granular control over JavaScript optimization.
