...
class AIOWPSecurity_Debug {
	...
	public static function send_report($email) {
		...
		$report .= '<body><h2>' . esc_html('All In One WP Security & Firewall diagnostics report') . '</h2>';
		...
		$report .= '<br><br><p>' . esc_html('This report was generated by the All In One WP Security & Firewall plugin.') . '</p></body></html>';
		$subject = esc_html('All In One WP Security & Firewall - diagnostic report');
