 ...
 function oa(a) {
    ...
    (0, a.registerBlockType)("info-box/infos", {
        ...
        edit: function (a) {
            ...
            return wp.element.createElement(
                ...
                wp.element.createElement(
                    "div",
                    { className: o, id: "nexcraftInfos-".concat(O) },
                    wp.element.createElement("style", {
                        dangerouslySetInnerHTML: {
                            __html: "\n                    @import url("
                                .concat(O, " .nexcraftInfos .nexcraftInfo .title{\n                        ")
                                .concat(O, " .nexcraftInfos .nexcraftInfo .description{\n                        "),
                        },
                    }),
                    wp.element.createElement(
                        "div",
    ...
    var Da = function (a) {
            ...
            return (
                ...
                wp.element.createElement(
                    ...
                    wp.element.createElement(
                        t.PanelRow,
                        { className: "nexcraftIconTitle ".concat(n) },
        ...
        Ra = function (a) {
            ...
            return (
                ...
                wp.element.createElement(
                    ...
                    wp.element.createElement(
                        "div",
                        { className: i, id: "nexcraftInfo-".concat(x) },
                        wp.element.createElement("style", {
                            dangerouslySetInnerHTML: {
                                __html: "\n                #nexcraftInfo-"
                                    .concat(x, " .nexcraftInfo .bgLayer{\n                    ")
                                    .concat(x, " .nexcraftInfo .title{\n                    color: ")
                                    .concat(x, " .nexcraftInfo .icon{\n                    ")
                                    .concat((null == m ? void 0 : m.styles) || "font-size: 70px;", "\n                }\n                #nexcraftInfo-")
                                    .concat(x, " .nexcraftInfo .description{\n                    color: ")
                                    .concat(x, " .nexcraftInfo .link a svg{\n                    fill: "),
                            },
                        }),
                        wp.element.createElement(
                            "div",
							{ className: "nexcraftInfo av-column-".concat(m.desktop, " columns-tablet-").concat(m.tablet, " av-sm-column-").concat(m.mobile)},
    ...
    (0, a.registerBlockType)("info-box/info", {
        ...
        attributes: {
            ...
            title: { type: "string", selector: ".nexcraftInfo span.title", default: "Info title" },
            isDesc: { type: "boolean", default: !0 },
            desc: { type: "string", selector: ".nexcraftInfo h3.description", default: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Accusamus, fuga." },
