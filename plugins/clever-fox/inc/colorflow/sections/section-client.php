							...
							<div class="inner-partner">
								<a href="<?php echo esc_url($link); ?>">
									...
									<?php if(!empty($title) || !empty($subtitle)): ?>
										<span class="client-name"><?php printf(	/* translators: %s: Title */__( '%s', 'clever-fox' ),$title); ?> <strong><?php printf(	/* translators: %s: Subtitle */__( '%s', 'clever-fox' ),$subtitle); ?></strong></span>
									<?php endif; ?>
								</a>
							</div>
						</div>
