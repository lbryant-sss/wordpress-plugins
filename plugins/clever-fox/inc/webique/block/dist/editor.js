 ...
 function oa(a) {
    ...
    (0, a.registerBlockType)("info-box/infos", {
        ...
        edit: function (a) {
            ...
            return wp.element.createElement(
                ...
                wp.element.createElement(
                    "div",
                    { className: o, id: "webiqueInfos-".concat(O) },
                    wp.element.createElement("style", {
                        dangerouslySetInnerHTML: {
                            __html: "\n                    @import url("
                                .concat(O, " .webiqueInfos .webiqueInfo .title{\n                        ")
                                .concat(O, " .webiqueInfos .webiqueInfo .description{\n                        "),
                        },
                    }),
                    wp.element.createElement(
                        "div",
    ...
    var Da = function (a) {
            ...
            return (
                ...
                wp.element.createElement(
                    ...
                    wp.element.createElement(
                        t.PanelRow,
                        { className: "webiqueIconTitle ".concat(n) },
        ...
        Ra = function (a) {
            ...
            return (
                ...
                wp.element.createElement(
                    ...
                    wp.element.createElement(
                        "div",
                        { className: i, id: "webiqueInfo-".concat(x) },
                        wp.element.createElement("style", {
                            dangerouslySetInnerHTML: {
                                __html: "\n                #webiqueInfo-"
                                    .concat(x, " .webiqueInfo .bgLayer{\n                    ")
                                    .concat(x, " .webiqueInfo .title{\n                    color: ")
                                    .concat(x, " .webiqueInfo .icon{\n                    ")
                                    .concat((null == m ? void 0 : m.styles) || "font-size: 70px;", "\n                }\n                #webiqueInfo-")
                                    .concat(x, " .webiqueInfo .description{\n                    color: ")
                                    .concat(x, " .webiqueInfo .link a svg{\n                    fill: "),
                            },
                        }),
                        wp.element.createElement(
                            "div",
							{ className: "webiqueInfo av-column-".concat(m.desktop, " columns-tablet-").concat(m.tablet, " av-sm-column-").concat(m.mobile)},
    ...
    (0, a.registerBlockType)("info-box/info", {
        ...
        attributes: {
            ...
            title: { type: "string", selector: ".webiqueInfo span.title", default: "Info title" },
            isDesc: { type: "boolean", default: !0 },
            desc: { type: "string", selector: ".webiqueInfo h3.description", default: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Accusamus, fuga." },
