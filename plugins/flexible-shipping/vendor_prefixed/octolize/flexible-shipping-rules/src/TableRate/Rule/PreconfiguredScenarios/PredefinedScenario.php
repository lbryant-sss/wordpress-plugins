...
class PredefinedScenario implements \JsonSerializable
{
     ...
     */
    public function __construct($category, $name, $description, $documentation_url, $rules_json, $available = \true, $reason_for_unavailability = '', $requirements = '')
    {
    ...
    {
        return ['category' => $this->category, 'name' => $this->name, 'description' => $this->description, 'documentation_url' => $this->documentation_url, 'rules_json' => $this->rules_json, 'available' => $this->available, 'reason_for_unavailability' => $this->reason_for_unavailability, 'requirements' => $this->requirements, 'rules_count' => $this->get_rules_count()];
    }
    /**
     * @return int
     */
    ...
    {
        $rules = json_decode($this->rules_json, \true);
        return count($rules);
    }
}
