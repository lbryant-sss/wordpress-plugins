...
class MollieOrderService
{
    ...
    public function onWebhookAction()
    {
        ...
        if ($this->container->get('settings.settings_helper')->isOrderApiSetting() && in_array($payment->method, [Constants::KLARNA, Constants::KLARNAPAYLATER, Constants::KLARNASLICEIT, Constants::KLARNAPAYNOW], \true) && strpos($paymentId, 'tr_') === 0) {
