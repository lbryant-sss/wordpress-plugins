...
class PaymentService
{
    ...
    protected function correctSurchargeFee($order, $paymentMethod)
    {
        ...
        $gatewayFeeLabel = get_option('mollie-payments-for-woocommerce_gatewayFeeLabel', $surcharge->defaultFeeLabel());
        $correctedFee = \false;
        foreach ($fees as $fee) {
    ...
    protected function processAsMollieOrder(\Mollie\WooCommerce\Payment\MollieOrder $paymentObject, $order, $customer_id, $apiKey)
    {
        ...
        try {
            ...
            $orderMandatoryPaymentMethods = ['mollie_wc_gateway_klarnapaylater', 'mollie_wc_gateway_klarnasliceit', 'mollie_wc_gateway_klarnapaynow', 'mollie_wc_gateway_klarna', 'mollie_wc_gateway_billie', 'mollie_wc_gateway_in3', 'mollie_wc_gateway_riverty'];
