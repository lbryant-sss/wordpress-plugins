...
class OrderLines
{
    ...
    private function process_shipping()
    {
        if ($this->order->get_shipping_methods() && WC()->session->get('chosen_shipping_methods')) {
            $shipping = ['type' => 'shipping_fee', 'name' => $this->get_shipping_name(), 'quantity' => 1, 'vatRate' => $this->get_shipping_vat_rate(), 'unitPrice' => ['currency' => $this->currency, 'value' => $this->dataHelper->formatCurrencyValue($this->get_shipping_amount(), $this->currency)], 'totalAmount' => ['currency' => $this->currency, 'value' => $this->dataHelper->formatCurrencyValue($this->get_shipping_amount(), $this->currency)], 'vatAmount' => ['currency' => $this->currency, 'value' => $this->dataHelper->formatCurrencyValue($this->get_shipping_tax_amount(), $this->currency)], 'metadata' => ['order_item_id' => $this->get_shipping_id()]];
