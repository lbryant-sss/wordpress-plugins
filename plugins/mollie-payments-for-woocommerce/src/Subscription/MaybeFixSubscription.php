...
class MaybeFixSubscription
{
    ...
    {
        $subscriptions = wcs_get_subscriptions(['subscriptions_per_page' => '-1', 'meta_query' => [['key' => '_mollie_customer_id', 'value' => '', 'compare' => 'NOT EXISTS']]]);
        ...
        update_option('mollie_wc_fix_subscriptions2', \true);
    }
}
