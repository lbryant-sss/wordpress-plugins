...
if ($argc < 2) {
    echo 'sabre/vobject ', AmeliaSabre\VObject\Version::VERSION, " freebusy benchmark\n";
    echo "\n";
...
$vcal = AmeliaSabre\VObject\Reader::read(fopen($inputFile, 'r'));
...
for ($i = 0; $i < $repeat; ++$i) {
    $fb = new AmeliaSabre\VObject\FreeBusyGenerator($start, $end, $vcal, $timeZone);
