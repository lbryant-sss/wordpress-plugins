 ...
 * @property null|(object{after_completion: (object{hosted_confirmation: null|(object{custom_message: null|string}&\AmeliaStripe\StripeObject), redirect: null|(object{return_url: string}&\AmeliaStripe\StripeObject), type: string}&\AmeliaStripe\StripeObject), subscription_cancel: null|(object{retention: null|(object{coupon_offer: null|(object{coupon: string}&\AmeliaStripe\StripeObject), type: string}&\AmeliaStripe\StripeObject), subscription: string}&\AmeliaStripe\StripeObject), subscription_update: null|(object{subscription: string}&\AmeliaStripe\StripeObject), subscription_update_confirm: null|(object{discounts: null|((object{coupon: null|string, promotion_code: null|string}&\AmeliaStripe\StripeObject))[], items: ((object{id: null|string, price: null|string, quantity?: int}&\AmeliaStripe\StripeObject))[], subscription: string}&\AmeliaStripe\StripeObject), type: string}&\AmeliaStripe\StripeObject) $flow Information about a specific flow for the customer to go through. See the <a href="https://stripe.com/docs/customer-management/portal-deep-links">docs</a> to learn more about using customer portal deep links and flows.
