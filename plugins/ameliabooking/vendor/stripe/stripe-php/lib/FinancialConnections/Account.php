 ...
 * @property null|(object{account?: string|\AmeliaStripe\Account, customer?: string|\AmeliaStripe\Customer, type: string}&\AmeliaStripe\StripeObject) $account_holder The account holder that this account belongs to.
 * @property null|(object{as_of: int, cash?: (object{available: null|\AmeliaStripe\StripeObject}&\AmeliaStripe\StripeObject), credit?: (object{used: null|\AmeliaStripe\StripeObject}&\AmeliaStripe\StripeObject), current: \AmeliaStripe\StripeObject, type: string}&\AmeliaStripe\StripeObject) $balance The most recent information about the account's balance.
 * @property null|(object{last_attempted_at: int, next_refresh_available_at: null|int, status: string}&\AmeliaStripe\StripeObject) $balance_refresh The state of the most recent attempt to refresh the account balance.
 ...
 * @property null|(object{last_attempted_at: int, next_refresh_available_at: null|int, status: string}&\AmeliaStripe\StripeObject) $ownership_refresh The state of the most recent attempt to refresh the account owners.
 ...
 * @property null|(object{id: string, last_attempted_at: int, next_refresh_available_at: null|int, status: string}&\AmeliaStripe\StripeObject) $transaction_refresh The state of the most recent attempt to refresh the account transactions.
 */
class Account extends \AmeliaStripe\ApiResource
{
     ...
     *
     * @return \AmeliaStripe\Collection<Account> of ApiResources
     *
     ...
     * @param null|array|string $opts
     *
     * @return \AmeliaStripe\Collection<AccountOwner> list of account owners
     *
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     */
