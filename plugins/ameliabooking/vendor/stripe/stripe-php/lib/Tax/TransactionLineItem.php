 ...
 * @property null|(object{original_line_item: string}&\AmeliaStripe\StripeObject) $reversal If <code>type=reversal</code>, contains information about what was reversed.
 ...
 */
class TransactionLineItem extends \AmeliaStripe\ApiResource
{
