 ...
 */
class CreditGrantService extends \AmeliaStripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \AmeliaStripe\Collection<\AmeliaStripe\Billing\CreditGrant>
     *
     ...
     * @param null|RequestOptionsArray|\AmeliaStripe\Util\RequestOptions $opts
     *
     * @return \AmeliaStripe\Billing\CreditGrant
     *
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     */
