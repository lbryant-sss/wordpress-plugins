 ...
 */
class RegistrationService extends \AmeliaStripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \AmeliaStripe\Collection<\AmeliaStripe\Tax\Registration>
     *
     ...
     * @param null|RequestOptionsArray|\AmeliaStripe\Util\RequestOptions $opts
     *
     * @return \AmeliaStripe\Tax\Registration
     *
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     */
