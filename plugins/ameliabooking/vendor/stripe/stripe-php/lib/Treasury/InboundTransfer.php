 ...
 * @property null|(object{code: string}&\AmeliaStripe\StripeObject) $failure_details Details about this InboundTransfer's failure. Only set when status is <code>failed</code>.
 ...
 * @property (object{received_debit: null|string}&\AmeliaStripe\StripeObject) $linked_flows
 ...
 * @property null|(object{billing_details: (object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\AmeliaStripe\StripeObject), email: null|string, name: null|string}&\AmeliaStripe\StripeObject), type: string, us_bank_account?: (object{account_holder_type: null|string, account_type: null|string, bank_name: null|string, fingerprint: null|string, last4: null|string, mandate?: string|\AmeliaStripe\Mandate, network: string, routing_number: null|string}&\AmeliaStripe\StripeObject)}&\AmeliaStripe\StripeObject) $origin_payment_method_details Details about the PaymentMethod for an InboundTransfer.
 ...
 * @property (object{canceled_at?: null|int, failed_at: null|int, succeeded_at: null|int}&\AmeliaStripe\StripeObject) $status_transitions
...
class InboundTransfer extends \AmeliaStripe\ApiResource
{
     ...
     *
     * @return \AmeliaStripe\Collection<InboundTransfer> of ApiResources
     *
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     */
