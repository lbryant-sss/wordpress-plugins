 ...
 * @property (object{cash: \AmeliaStripe\StripeObject, inbound_pending: \AmeliaStripe\StripeObject, outbound_pending: \AmeliaStripe\StripeObject}&\AmeliaStripe\StripeObject) $balance Balance information for the FinancialAccount
 ...
 * @property ((object{aba?: (object{account_holder_name: string, account_number?: null|string, account_number_last4: string, bank_name: string, routing_number: string}&\AmeliaStripe\StripeObject), supported_networks?: string[], type: string}&\AmeliaStripe\StripeObject))[] $financial_addresses The set of credentials that resolve to a FinancialAccount.
 ...
 * @property null|(object{inbound_flows: null|string, outbound_flows: null|string}&\AmeliaStripe\StripeObject) $platform_restrictions The set of functionalities that the platform can restrict on the FinancialAccount.
 ...
 * @property (object{closed: null|(object{reasons: string[]}&\AmeliaStripe\StripeObject)}&\AmeliaStripe\StripeObject) $status_details
...
class FinancialAccount extends \AmeliaStripe\ApiResource
{
     ...
     *
     * @return \AmeliaStripe\Collection<FinancialAccount> of ApiResources
     *
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     */
