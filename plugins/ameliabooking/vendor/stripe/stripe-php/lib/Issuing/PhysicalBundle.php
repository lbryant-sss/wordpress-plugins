 ...
 * @property (object{card_logo: string, carrier_text: string, second_line: string}&\AmeliaStripe\StripeObject) $features
 ...
 */
class PhysicalBundle extends \AmeliaStripe\ApiResource
{
     ...
     *
     * @return \AmeliaStripe\Collection<PhysicalBundle> of ApiResources
     *
