...
if (!class_exists('BVProtectFWRuleEngine_V588')) :
require_once dirname( __FILE__ ) . '/functions.php';

class BVProtectFWRuleEngine_V588 {
	use BVProtectFWRuleStringFunc_V588;
	use BVProtectFWRuleArrayFunc_V588;
	use BVProtectFWRuleMiscFunc_V588;
	use BVProtectFWRuleRequestFunc_V588;
	use BVProtectFWRuleWPFunc_V588;
	...
	const CONST_NAME_PREFIX = 'BVProtectFWRule_V588::';
	...
	public function evaluate($rule) {
		...
		} catch (BVProtectRuleError_V588 $e) {
			$this->error = $e;
		}
	}
