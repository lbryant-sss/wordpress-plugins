...
if (!class_exists('BVProtectFWRuleEngine_V593')) :
require_once dirname( __FILE__ ) . '/functions.php';

class BVProtectFWRuleEngine_V593 {
	use BVProtectFWRuleStringFunc_V593;
	use BVProtectFWRuleArrayFunc_V593;
	use BVProtectFWRuleMiscFunc_V593;
	use BVProtectFWRuleRequestFunc_V593;
	use BVProtectFWRuleWPFunc_V593;
	...
	const CONST_NAME_PREFIX = 'BVProtectFWRule_V593::';
	...
	public function evaluate($rule) {
		...
		} catch (BVProtectRuleError_V593 $e) {
			$this->error = $e;
		}
	}
