...
?>
<p>
  Pro users can now specify browser specific iframes. This is important especially for the "Show only part of the iframe"
  feature where browser differences of a few pixels can matter. But you can use this for other things as well because
  mobile, iphone, ipad can also be detected.
</p>
<?php if ($evanto || $isDemo) {
  ...
  <p>
    <a href="#"
       onclick="jQuery('#browser-help').show(); return false;"> <?php _e('Show me how to configure the browser detection in advanced iframe pro.','advanced-iframe') ?></a>
  </p>
  <?php
