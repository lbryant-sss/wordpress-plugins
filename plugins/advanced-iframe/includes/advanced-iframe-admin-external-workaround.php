...
<div>
  ...
  ?>
  <p><?php _e('This solution was removed in version 2024.6 because it is not supported in chrome anymore since Mai 2023. Please use the solution explained in the next section.', 'advanced-iframe');
    aiPostboxClose();
