  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(SelectCptTaxonomy, [{
    ...
    value: function fetchTaxonomies() {
      ...
      var _this$props = this.props,
        ...
        block_taxonomy = _this$props.block_taxonomy;
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @wordpress/element */ "react");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (registerBlockType('wpgoplugins/simple-sitemap-group-block', {
  ...
  edit: function edit(props) {
    ...
    return [(0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(InspectorControls, {
      key: "simple-sitemap-group-block-controls"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(PanelBody, {
      title: __('General Settings', 'simple-sitemap')
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(PanelRow, {
      className: "simple-sitemap"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_components_select_cpt_taxonomy__WEBPACK_IMPORTED_MODULE_1__.SelectCptTaxonomy, {
    ...
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)("h3", {
      style: {
        marginBottom: '-12px'
      }
    }, "Post ordering")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(PanelRow, {
      className: "simple-sitemap order"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(SelectControl, {
      label: "Orderby",
      value: orderby,
      options: [{
        label: 'Title',
    ...
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_components_checkbox__WEBPACK_IMPORTED_MODULE_2__.SitemapCheckboxControl, {
      value: show_label,
    ...
    })), sitemapGroupGeneralSettings), sitemapGroupGeneralStyles, sitemapGroupFeaturedImage), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(ServerSideRender, {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (registerBlockType('wpgoplugins/simple-sitemap-block', {
  ...
  edit: function edit(props) {
    ...
    var _props$attributes = props.attributes,
      ...
      order = _props$attributes.order,
      orderby = _props$attributes.orderby,
      target_blank = _props$attributes.target_blank,
      post_type_label = _props$attributes.post_type_label,
      setAttributes = props.setAttributes,
      attributes = props.attributes;
    ...
    var selectPostTypes = applyFilters('sitemap-post-types-select', (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(react_select__WEBPACK_IMPORTED_MODULE_4__["default"], {
      title: "Title",
    ...
    var postTypesHelpLabel = applyFilters('post-types-help-label', (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(PanelRow, {
      className: "panel-row-help-label"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)("p", {
      style: {
        marginTop: '-20px',
        fontSize: '13px',
        fontStyle: 'italic',
    ...
    }, "List", ' ', (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)("a", {
    ...
    var postTypesParse = JSON.parse(block_post_types);
    useEffect(function () {
      var findPost = false;
      if ('undefined' === typeof post_type_label) {
        ...
        setRenamedCptNewLabel(Object.values(post_type_label)[0] || '');
      }
      postTypesParse.forEach(function (postType) {
      ...
      if (!findPost) {
        var _postTypesParse$;
        var newRenamedkey = (_postTypesParse$ = postTypesParse[0]) === null || _postTypesParse$ === void 0 ? void 0 : _postTypesParse$.value;
    ...
    var _useState = useState((_postTypesParse$2 = postTypesParse[0]) === null || _postTypesParse$2 === void 0 ? void 0 : _postTypesParse$2.value),
      _useState2 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__["default"])(_useState, 2),
      renamedCptKey = _useState2[0],
      setRenamedCptKey = _useState2[1];
    var _useState3 = useState(''),
      _useState4 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__["default"])(_useState3, 2),
      renamedCptNewLabel = _useState4[0],
      setRenamedCptNewLabel = _useState4[1];
    var updateCptRenamedLabels = function updateCptRenamedLabels(value) {
      var temp = _objectSpread({}, post_type_label);
      ...
      setAttributes({
        post_type_label: _objectSpread({}, temp)
      });
    ...
    return [(0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(InspectorControls, {
    ...
    }, "Select post types to display")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(PanelRow, null, selectPostTypes), postTypesHelpLabel, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(PanelRow, {
      className: "simple-sitemap order"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(SelectControl, {
      label: "Orderby",
      value: orderby,
      ...
      updateCheckbox: updateLinks
    })), links && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(PanelRow, {
      className: "simple-sitemap general-chk"
      ...
      value: target_blank,
      label: __('Open links in new tab', 'simple-sitemap'),
      updateCheckbox: function updateCheckbox(isChecked) {
        setAttributes({
          target_blank: isChecked
        });
      }
    }))), sitemapGeneralSettings), 0 < postTypesParse.length && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(PanelBody, {
      ...
      onChange: function onChange(value) {
        if (post_type_label[value]) {
          setRenamedCptNewLabel(post_type_label[value]);
        } else {
          setRenamedCptNewLabel('');
        }
        setRenamedCptKey(value);
      }
    }))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(PanelRow, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(TextControl, {
      label: __('New Label', 'simple-sitemap'),
      value: renamedCptNewLabel,
      onChange: function onChange(value) {
        updateCptRenamedLabels(value);
      }
    }))), sitemapGeneralStyles, sitemapFeaturedImage, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(PanelBody, {
    ...
    })), sitemapTabControls), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(PanelBody, {
      title: __('Page Settings', 'simple-sitemap'),
      initialOpen: false
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(PanelRow, {
      className: "simple-sitemap"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)("p", null, "Affects sitemap pages only.")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(PanelRow, {
      className: "simple-sitemap"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(TextControl, {
      type: "number",
