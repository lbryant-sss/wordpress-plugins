    ...
    <div id="csmm-setting-form-mc" style="<?php if ($signals_csmm_options['mail_system_to_use'] != 'mc') echo 'display: none;' ?>">
		<div class="signals-section-content">
			<div class="signals-double-group signals-clearfix">
				<div class="signals-form-group">
					...
					<input type="text" name="signals_csmm_input_text" id="signals_csmm_input_text" value="<?php esc_attr( stripslashes( $signals_csmm_options['input_text'] ) ); ?>" placeholder="<?php esc_attr_e( 'Text for the Input field', 'minimal-coming-soon-maintenance-mode' ); ?>" class="signals-form-control">
				...
				<div class="signals-form-group">
					...
					<input type="text" name="signals_csmm_button_text" id="signals_csmm_button_text" value="<?php esc_attr( stripslashes( $signals_csmm_options['button_text'] ) ); ?>" placeholder="<?php esc_attr_e( 'Text for the Button', 'minimal-coming-soon-maintenance-mode' ); ?>" class="signals-form-control">
          ...
          <p class="signals-form-help-block">It's preferable to ask for a name as it gives you the option to personalize communication later on. This is a <a href="#pro" class="csmm-change-tab">PRO feature</a>.</p>
			...
			<div class="signals-double-group signals-clearfix">
				<div class="signals-form-group">
					...
					<input type="text" name="signals_csmm_input_color" id="signals_csmm_input_color" value="<?php echo esc_attr( $signals_csmm_options['input_font_color'] ); ?>" placeholder="<?php esc_attr_e( 'Font color for the Input text', 'minimal-coming-soon-maintenance-mode' ); ?>" class="signals-form-control color jscolor {required:false}">
				...
				<div class="signals-form-group">
					...
					<input type="text" name="signals_csmm_button_color" id="signals_csmm_button_color" value="<?php echo esc_attr( $signals_csmm_options['button_font_color'] ); ?>" placeholder="<?php esc_attr_e( 'Font color for the Button text', 'minimal-coming-soon-maintenance-mode' ); ?>" class="signals-form-control color jscolor {required:false}">
			...
			<div class="signals-double-group signals-clearfix">
				<div class="signals-form-group">
					...
					<input type="text" name="signals_csmm_input_bg" id="signals_csmm_input_bg" value="<?php echo esc_attr( $signals_csmm_options['input_bg'] ); ?>" placeholder="<?php esc_attr_e( 'Background color for the Input field', 'minimal-coming-soon-maintenance-mode' ); ?>" class="signals-form-control color jscolor {required:false}">
				...
				<div class="signals-form-group">
					...
					<input type="text" name="signals_csmm_button_bg" id="signals_csmm_button_bg" value="<?php echo esc_attr( $signals_csmm_options['button_bg'] ); ?>" placeholder="<?php esc_attr_e( 'Background color for the Button', 'minimal-coming-soon-maintenance-mode' ); ?>" class="signals-form-control color jscolor {required:false}">
			...
			<div class="signals-double-group signals-clearfix">
				<div class="signals-form-group">
					...
					<input type="text" name="signals_csmm_input_bg_hover" id="signals_csmm_input_bg_hover" value="<?php echo esc_attr( $signals_csmm_options['input_bg_hover'] ); ?>" placeholder="<?php esc_attr_e( 'Background color for the Input field when it gets clicked', 'minimal-coming-soon-maintenance-mode' ); ?>" class="signals-form-control color jscolor {required:false}">
				...
				<div class="signals-form-group">
					...
					<input type="text" name="signals_csmm_button_bg_hover" id="signals_csmm_button_bg_hover" value="<?php echo esc_attr( $signals_csmm_options['button_bg_hover'] ); ?>" placeholder="<?php esc_attr_e( 'Background color for the Button on hover', 'minimal-coming-soon-maintenance-mode' ); ?>" class="signals-form-control color jscolor {required:false}">
			...
			<div class="signals-double-group signals-clearfix">
				<div class="signals-form-group">
					...
					<input type="text" name="signals_csmm_input_border" id="signals_csmm_input_border" value="<?php echo esc_attr( $signals_csmm_options['input_border'] ); ?>" placeholder="<?php esc_attr_e( 'Border color for the Input field', 'minimal-coming-soon-maintenance-mode' ); ?>" class="signals-form-control color jscolor {required:false}">
				...
				<div class="signals-form-group">
					...
					<input type="text" name="signals_csmm_button_border" id="signals_csmm_button_border" value="<?php echo esc_attr( $signals_csmm_options['button_border'] ); ?>" placeholder="<?php esc_attr_e( 'Border color for the Button', 'minimal-coming-soon-maintenance-mode' ); ?>" class="signals-form-control color jscolor {required:false}">
			...
			<div class="signals-double-group signals-clearfix">
				<div class="signals-form-group">
					...
					<input type="text" name="signals_csmm_input_border_hover" id="signals_csmm_input_border_hover" value="<?php echo esc_attr( $signals_csmm_options['input_border_hover'] ); ?>" placeholder="<?php esc_attr_e( 'Border color for the Input field when it gets clicked', 'minimal-coming-soon-maintenance-mode' ); ?>" class="signals-form-control color jscolor {required:false}">
				...
				<div class="signals-form-group">
					...
					<input type="text" name="signals_csmm_button_border_hover" id="signals_csmm_button_border_hover" value="<?php echo esc_attr( $signals_csmm_options['button_border_hover'] ); ?>" placeholder="<?php esc_attr_e( 'Border color for the Button on hover', 'minimal-coming-soon-maintenance-mode' ); ?>" class="signals-form-control color jscolor {required:false}">
      ...
      <div class="signals-double-group signals-clearfix">
        <div class="signals-form-group">
          ...
          <input type="text" name="form_placeholder_color" id="form_placeholder_color" value="<?php echo esc_attr( $signals_csmm_options['form_placeholder_color'] ); ?>" class="signals-form-control color jscolor {required:false}">
          <p class="signals-form-help-block"><?php esc_attr_e( 'Placeholder (default text) color in input fields.', 'minimal-coming-soon-maintenance-mode' ); ?></p>
			...
			<div class="signals-double-group signals-clearfix">
				<div class="signals-form-group">
					...
					<input type="text" name="signals_csmm_success_bg" id="signals_csmm_success_bg" value="<?php echo esc_attr( $signals_csmm_options['success_background'] ); ?>" placeholder="<?php esc_attr_e( 'Background color for the success message', 'minimal-coming-soon-maintenance-mode' ); ?>" class="signals-form-control color jscolor {required:false}">
				...
				<div class="signals-form-group">
					...
					<input type="text" name="signals_csmm_success_color" id="signals_csmm_success_color" value="<?php echo esc_attr( $signals_csmm_options['success_color'] ); ?>" placeholder="<?php esc_attr_e( 'Text color for the success message', 'minimal-coming-soon-maintenance-mode' ); ?>" class="signals-form-control color jscolor {required:false}">
			...
			<div class="signals-double-group signals-clearfix">
				<div class="signals-form-group">
					...
					<input type="text" name="signals_csmm_error_bg" id="signals_csmm_error_bg" value="<?php echo esc_attr( $signals_csmm_options['error_background'] ); ?>" placeholder="<?php esc_attr_e( 'Background color for the error message', 'minimal-coming-soon-maintenance-mode' ); ?>" class="signals-form-control color jscolor {required:false}">
				...
				<div class="signals-form-group">
					...
					<input type="text" name="signals_csmm_error_color" id="signals_csmm_error_color" value="<?php echo esc_attr( $signals_csmm_options['error_color'] ); ?>" placeholder="<?php esc_attr_e( 'Text color for the error message', 'minimal-coming-soon-maintenance-mode' ); ?>" class="signals-form-control color jscolor {required:false}">
