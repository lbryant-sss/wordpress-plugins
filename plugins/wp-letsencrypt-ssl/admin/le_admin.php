...
class WPLE_Admin
{
    ...
    public function wple_upgrade_block(&$html)
    {
        ...
        ///$upgradeurl = admin_url('/admin.php?page=wp_encryption-pricing&checkout=true&billing_cycle_selector=responsive_list&plan_id=8210&plan_name=pro&billing_cycle=lifetime&pricing_id=7965&currency=usd&coupon=FIRSTBUY');
      ...
      <div id="wple-upgradepro">';
        ...
        if ($nopricing) {
            $compareurl = admin_url('/admin.php?page=wp_encryption&comparison=1');
            //$upgradeurl = admin_url('/admin.php?page=wp_encryption-pricing&checkout=true&billing_cycle_selector=responsive_list&plan_id=11394&plan_name=pro&billing_cycle=annual&pricing_id=11717&currency=usd');
    ...
    public function wple_complete_block(&$html)
    {
      ...
      <div class="wple-success-form">';
        ...
        $nonroot_instruction = sprintf(
            ...
            '<a href="' . admin_url('/admin.php?page=wp_encryption-pricing&checkout=true&billing_cycle_selector=responsive_list&checkout_style=legacy&plan_id=8210&plan_name=pro&billing_cycle=annual&pricing_id=7965&currency=usd') . '"><strong>',
            '</strong></a>'
        );
    ...
    public function wple_reminder_notice()
    {
        ...
        <a class="wple-lets-review wplerevbtn" href="' . admin_url('/admin.php?page=wp_encryption-pricing&checkout=true&billing_cycle_selector=responsive_list&checkout_style=legacy&plan_id=8210&plan_name=pro&billing_cycle=lifetime&pricing_id=7965&currency=usd') . '">' . esc_html__('Upgrade to Pro', 'wp-letsencrypt-ssl') . '</a>
