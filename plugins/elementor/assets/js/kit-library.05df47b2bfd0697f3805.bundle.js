...
var KitListCloudItem = function KitListCloudItem(props) {
  ...
  }, isLocked && /*#__PURE__*/_react.default.createElement("i", {
...
function QuotaBar(_ref) {
  ...
  var usagePercentage = Math.min(displayValues.used / displayValues.total * 100, 100);
  var getUsageState = function getUsageState() {
    ...
    var matchingThreshold = USAGE_THRESHOLDS.reverse().find(function (_ref2) {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    variant: "xs",
    tag: "span"
  }, displayValues.used, " ", displayValues.unit, " ", __('of', 'elementor'), " ", displayValues.total, " ", displayValues.unit)), /*#__PURE__*/_react.default.createElement("div", {
  ...
  var getNotificationContent = function getNotificationContent() {
    ...
    if ('warning' === state) {
      return {
        ...
        message: "".concat(__('Website template storage is', 'elementor'), " ").concat(Math.round(usagePercentage), "% ").concat(__('full. Get more space by ', 'elementor')),
        actions: [{
          text: __('Cleaning up space', 'elementor'),
          href: '#',
          type: 'link'
...
//# sourceMappingURL=kit-library.05df47b2bfd0697f3805.bundle.js.map