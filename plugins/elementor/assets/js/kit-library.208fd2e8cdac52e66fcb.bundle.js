...
var _useCloudKitsEligibility = _interopRequireDefault(__webpack_require__(/*! ./hooks/use-cloud-kits-eligibility */ "../app/modules/kit-library/assets/js/hooks/use-cloud-kits-eligibility.js"));
...
function AppContent() {
  var _useCloudKitsEligibil = (0, _useCloudKitsEligibility.default)(),
    isCloudKitsAvailable = _useCloudKitsEligibil.data;
  return /*#__PURE__*/_react.default.createElement(_settingsContext.SettingsProvider, {
    ...
    path: "/overview/:id"
  }), isCloudKitsAvailable && /*#__PURE__*/_react.default.createElement(_cloud.default, {
    path: "/cloud"
  }))));
}
function App() {
...
function KitCloudDeleteDialog(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(_appUi.Dialog, {
    ...
    text: /* Translators: %s: Kit title. */(0, _i18n.sprintf)(__('Removing %s will permanently delete changes made to the site design and settings.', 'elementor'), (kit === null || kit === void 0 ? void 0 : kit.title) || ''),
...
function useCloudKitsEligibility() {
  return (0, _reactQuery.useQuery)([KEY], _cloudKits.fetchCloudKitsEligibility);
}
...
var _toConsumableArray2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/toConsumableArray */ "../node_modules/@babel/runtime/helpers/toConsumableArray.js"));
var _react = __webpack_require__(/*! react */ "react");
var _useCloudKitsEligibility = _interopRequireDefault(__webpack_require__(/*! ./use-cloud-kits-eligibility */ "../app/modules/kit-library/assets/js/hooks/use-cloud-kits-eligibility.js"));
/**
...
function useMenuItems(path) {
  ...
  return (0, _react.useMemo)(function () {
    ...
    }].concat((0, _toConsumableArray2.default)(isCloudKitsAvailable ? [{
...
//# sourceMappingURL=kit-library.208fd2e8cdac52e66fcb.bundle.js.map