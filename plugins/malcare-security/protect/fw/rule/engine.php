...
if (!class_exists('MCProtectFWRuleEngine_V592')) :
require_once dirname( __FILE__ ) . '/functions.php';

class MCProtectFWRuleEngine_V592 {
	use MCProtectFWRuleStringFunc_V592;
	use MCProtectFWRuleArrayFunc_V592;
	use MCProtectFWRuleMiscFunc_V592;
	use MCProtectFWRuleRequestFunc_V592;
	use MCProtectFWRuleWPFunc_V592;
	...
	const CONST_NAME_PREFIX = 'MCProtectFWRule_V592::';
	...
	public function evaluate($rule) {
		...
		} catch (MCProtectRuleError_V592 $e) {
			$this->error = $e;
		}
	}
