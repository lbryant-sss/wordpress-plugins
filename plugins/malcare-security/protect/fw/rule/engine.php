...
if (!class_exists('MCProtectFWRuleEngine_V588')) :
require_once dirname( __FILE__ ) . '/functions.php';

class MCProtectFWRuleEngine_V588 {
	use MCProtectFWRuleStringFunc_V588;
	use MCProtectFWRuleArrayFunc_V588;
	use MCProtectFWRuleMiscFunc_V588;
	use MCProtectFWRuleRequestFunc_V588;
	use MCProtectFWRuleWPFunc_V588;
	...
	const CONST_NAME_PREFIX = 'MCProtectFWRule_V588::';
	...
	public function evaluate($rule) {
		...
		} catch (MCProtectRuleError_V588 $e) {
			$this->error = $e;
		}
	}
