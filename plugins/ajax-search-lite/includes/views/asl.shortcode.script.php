...
$search_config = array(
	...
	'highlight'           => $style['kw_highlight'],
	'highlightwholewords' => intval($style['kw_highlight_whole_words']),
	...
	'autocomplete'        => array(
		'enabled'           => w_isset_def($style['autocomplete'], 1),
	...
	'closeOnDocClick'     => w_isset_def($style['close_on_document_click'], 1),
