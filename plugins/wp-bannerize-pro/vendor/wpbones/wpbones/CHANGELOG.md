...
- Added new [WPBannerize-Cron-Boilerplate](https://github.com/wpbones/WPBannerize-Cron-Boilerplate) example plugin
- Added new [WPBannerize-Hooks-Boilerplate](https://github.com/wpbones/WPBannerize-Hooks-Boilerplate) example plugin
...
- Added new [WPBannerize-Database-Boilerplate](https://github.com/wpbones/WPBannerize-Database-Boilerplate) example plugin.
...
- Updated and improved the [WPBannerize Demo](https://github.com/wpbones/WPBannerize) plugin.
...
- Added new [WP Bones API Boilerplate](https://github.com/wpbones/WPBannerize-API-Boilerplate) example plugin.
- Added new [WP Bones Internationalization Boilerplate](https://github.com/wpbones/WPBannerize-Internationalization-Boilerplate) example plugin.
- Added new [WP Bones Mantine Boilerplate](https://github.com/wpbones/WPBannerize-Mantine-Boilerplate) example plugin.
- Added new [WP Bones ReactJS Boilerplate](https://github.com/wpbones/WPBannerize-ReactJS-Boilerplate) example plugin.
- Added new [WP Bones Routes Boilerplate](https://github.com/wpbones/WPBannerize-Routes-Boilerplate) example plugin.
...
- Updated the [WPBones demo plugin](https://github.com/wpbones/WPBannerize).
- Updated the [WPBones Boilerplate plugin](https://github.com/wpbones/WPBannerize-Boilerplate)
...
- In the [WPBones demo plugin](https://github.com/wpbones/WPBannerize) and [WPBones Boilerplate plugin](https://github.com/wpbones/WPBannerize-Boilerplate) we have renamed the `localization` folder to `languages`.
