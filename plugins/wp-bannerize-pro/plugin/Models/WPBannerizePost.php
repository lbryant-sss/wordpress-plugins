...
class WPBannerizePost
{
    ...
    public function display()
    {
        ...
        ?>
    <div class="<?php echo esc_attr(implode(' ', $classes)); ?>" style="<?php echo esc_attr(
        $styles
    ); ?>" data-title="<?php echo esc_attr($this->post_title); ?>" data-mime_type="<?php echo esc_attr(
        sanitize_title($this->banner_mime_type)
    ); ?>" <?php echo empty(wpbones_value($this->banner_impressions_enabled))
                                                                                              ? ''
                                                                                              : ' data-impressions_enabled="true"'; ?> <?php echo empty(wpbones_value($this->banner_clicks_enabled))
                                                                                                                                          ? ''
                                                                                                                                          : ' data-clicks_enabled="true"'; ?> data-banner_id="<?php echo esc_attr(
                                                                                                                                              $this->ID
                                                                                                                                          ); ?>" id="wpbanner-<?php echo esc_attr($this->ID); ?>">
      <?php echo $content; ?>
    </div>
<?php
    }
