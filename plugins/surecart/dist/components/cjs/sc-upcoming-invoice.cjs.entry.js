...
const ScUpcomingInvoice = class {
    ...
    render() {
        return (index.h("div", { key: '4c41af0eb43ddabb37183e70005b0679328b9d16', class: "upcoming-invoice" }, this.error && (index.h("sc-alert", { key: 'f9291787f9b45c84fb4df64529b200f7f3b52774', open: !!this.error, type: "danger" }, index.h("span", { key: 'af9cb97a483c64bf8401a87c9b91d62799eccd75', slot: "title" }, wp.i18n.__('Error', 'surecart')), this.error)), index.h(index.Fragment, { key: '114358083a3fb9dda4d530ed8fe3d301d62666f1' }, index.h("sc-dashboard-module", { key: 'e1e42716f139e7150c223235239c0a34ca77d6b6', heading: wp.i18n.__('New Plan', 'surecart'), class: "plan-preview", error: this.error }, index.h("sc-card", { key: 'ccad51e1bb0ea56703813c33c2d84ef7d8f03874' }, this.renderContent())), index.h("sc-dashboard-module", { key: '4e5027c0047f1613dc5828ec5ade7a0eb3857361', heading: wp.i18n.__('Summary', 'surecart'), class: "plan-summary" }, index.h("sc-form", { key: 'a529ed92272506af2655cbc985a510c5fcb439eb', onScFormSubmit: () => this.onSubmit() }, index.h("sc-card", { key: 'f9727a3cadd87be0e7557e2c907ecd0238be6369' }, this.renderSummary()), index.h("sc-button", { key: 'e56eaa247f1d1296fcf826e63ab64c5032816c0b', type: "primary", full: true, submit: true, loading: this.loading || this.busy, disabled: this.loading || this.busy }, wp.i18n.__('Confirm', 'surecart')))), index.h("sc-text", { key: '630ae11f065e6c9e1e3ad864ec8a51cb43a6087a', style: { '--text-align': 'center', '--font-size': 'var(--sc-font-size-small)', '--line-height': 'var(--sc-line-height-normal)' } }, index.h("slot", { key: '244572f6dc9b596ae3eb3d336de06e9d32af55f8', name: "terms" }))), this.busy && index.h("sc-block-ui", { key: 'c1a0296393f1667ef2a47e1d03fd8d51dd2b5b8b' })));
    }
