...
const ScStackedList = class {
    ...
    render() {
        return index.h("slot", { key: '52ae8d45dc05ba95d4858e6e5b0b86ead6a4cab9' });
    }
};
...
const ScStackedListRow = class {
    ...
    render() {
        ...
        return (index.h(Tag, { key: 'd01e5a437ee389f79dc16dbd0a7a595672f72280', href: this.href, target: this.target, part: "base", class: {
                'list-row': true,
            ...
            } }, index.h("span", { key: '5ad003df048418e130b0bbcead6951c68164bd90', class: "list-row__prefix" }, index.h("slot", { key: '5e1f3d2295e9b321b59bf6972c8506c3c36c8c2c', name: "prefix", onSlotchange: () => this.handleSlotChange() })), index.h("slot", { key: '5e978709ded17e8d458d797cc0c3b8b974916612', onSlotchange: () => this.handleSlotChange() }), index.h("span", { key: '75bc3bcf05565c2fb4938b1e9a60a5ff54644fb6', class: "list-row__suffix" }, index.h("slot", { key: '3f613cf46df9a1e220a3110144257c1b866b15b4', name: "suffix", onSlotchange: () => this.handleSlotChange() }))));
    }
