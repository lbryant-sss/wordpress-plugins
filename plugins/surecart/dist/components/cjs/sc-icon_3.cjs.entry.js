...
const ScProductLineItem = class {
    ...
    render() {
        var _a, _b;
        return (index.h("div", { key: 'dddeb7f6162b33c420798c1d72ad3d153aaf6448', class: "base", part: "base" }, index.h("div", { key: 'c6d6289d07b1a6cf18800a4eb03155b4c39ca36a', part: "product-line-item", class: {
                'item': true,
            ...
            } }, !!((_b = this.image) === null || _b === void 0 ? void 0 : _b.src) ? index.h("img", { ...this.image, part: "image", class: "item__image" }) : index.h("div", { class: "item__image-placeholder" }), index.h("div", { key: 'a4c5192de8a5a3cfeecd3f59c1be88cc4b0e48c6', class: "item__text-container" }, index.h("div", { key: '21c44887c7e121376a10d260e88113b669c0afe3', class: "item__row" }, index.h("div", { key: 'c490d325a4c8f5c4785d2e108abbfb6a99159744', class: "item__title", part: "title" }, index.h("slot", { key: '5d8d22477fe8aef348ae590490abc4ecc9bd3a13', name: "title" }, this.name)), index.h("div", { key: 'c91fdf3e765b5cda2c5f3cf85b32a10bd86bf8b3', class: "price", part: "price__amount" }, !!this.scratch && this.scratch !== this.amount && index.h("span", { key: '37e317b4556b54c795cebfda093854b154c7d4f4', class: "item__scratch-price" }, this.scratch), this.amount, index.h("div", { key: 'c386fb3f31977a2fb09705a2bbdbdd86533b0def', class: "price__description", part: "price__description" }, this.interval))), index.h("div", { key: '115fb458d8723c9e5bb17924b05c5053ad3f6a94', class: "item__row" }, index.h("div", { key: 'ac10a97388acf7160fbce7df048098e82364a838', class: "item__description", part: "description" }, this.variant && index.h("div", { key: 'e644fec34259e8d01aba6ff26129ce51dc67ad3e' }, this.variant), this.price && index.h("div", { key: '1ff98f5bf7151a7b6766fb6c0731987a16b6fb1d' }, this.price), this.sku && (index.h("div", { key: '4648ead5d1bfdf6c99365ff8f6dc7bc9a607a3da' }, wp.i18n.__('SKU:', 'surecart'), " ", this.sku)), !!this.purchasableStatus && index.h("div", { key: 'fd40d4f5a250520b31f5bd651defc3f8a379b8df' }, this.purchasableStatus)), index.h("div", { key: 'c81d232c2c3c1f15f19cfd81b2d5accb439a3895', class: "item__description", part: "trial-fees" }, !!this.trial && index.h("div", { key: '306898dd97aa25a5b554f55d7a06cb061c1817a5' }, this.trial), (this.fees || []).map(fee => {
            return (index.h("div", null, fee === null || fee === void 0 ? void 0 :
                fee.display_amount, " ", fee === null || fee === void 0 ? void 0 :
                fee.description));
        }))), index.h("div", { key: '991f1e0b40bbb84486076557f18a2e6d0166f7a9', class: "item__row stick-bottom" }, this.editable ? (index.h("sc-quantity-select", { max: this.max || Infinity, exportparts: "base:quantity, minus:quantity__minus, minus-icon:quantity__minus-icon, plus:quantity__plus, plus-icon:quantity__plus-icon, input:quantity__input", clickEl: this.el, quantity: this.quantity, size: "small", onScChange: e => e.detail && this.scUpdateQuantity.emit(e.detail), "aria-label": 
            /** translators: %1$s: product name, %2$s: product price name */
            wp.i18n.sprintf(wp.i18n.__('Change Quantity - %1$s %2$s', 'surecart'), this.name, this.price) })) : (index.h("span", { class: "item__description", part: "static-quantity" }, wp.i18n.__('Qty:', 'surecart'), " ", this.quantity)), !!this.removable && (index.h("div", { key: '066cfb8fe402f6bb47df3aceb1f3cfd22defca37', class: "item__remove-container", onClick: () => this.scRemove.emit(), onKeyDown: e => {
                if (e.key === 'Enter') {
                    this.scRemove.emit();
                }
            }, "aria-label": wp.i18n.sprintf(wp.i18n.__('Remove Item - %1$s %2$s', 'surecart'), this.name, this.price), tabIndex: 0 }, index.h("sc-icon", { key: 'fe0e4d43d9b30064f6798a7359309f4339cc497a', exportparts: "base:remove-icon__base", class: "item__remove", name: "x" }), index.h("span", { key: 'e06ee959898c75ae421b1761c3793df0eefa9cf0', class: "item__remove-text" }, wp.i18n.__('Remove', 'surecart')))))))));
    }
