...
const ScPurchaseDownloadsList = class {
    ...
    render() {
        return (index.h("sc-dashboard-module", { key: '8a29b05cba17431b07c74f54a0acaecfcb82f666', class: "downloads-list", error: this.error }, index.h("span", { key: '3767b6e54d621fa412e18f6a8700cabaa6d2adff', slot: "heading" }, index.h("slot", { key: '510cc1cf3d54c7b030d463f49a1f2ad165273e87', name: "heading" }, this.heading || wp.i18n.__('Items', 'surecart'))), index.h("slot", { key: 'e11cfec692ef3e767f532b5f43984b0e3bdbac30', name: "before" }), !!this.allLink && (index.h("sc-button", { key: 'b85a50c356769213c2d7c4d7a234cb87048ef477', type: "link", href: this.allLink, slot: "end" }, wp.i18n.__('View all', 'surecart'), index.h("sc-icon", { key: '4563f0489c90be8a951c62ccc7c40d744a90ede3', name: "chevron-right", slot: "suffix" }))), this.renderContent(), index.h("slot", { key: 'cf64118474f699b8ca39758ad7cbad0b8865b999', name: "after" }), this.busy && index.h("sc-block-ui", { key: 'b071ee482c5fd38b6f44182f757f005c11ad1aba' })));
    }
