...
const ScPurchaseDownloadsList = class {
    ...
    render() {
        return (index.h("sc-dashboard-module", { key: '981183eba589bf837e4932cafa7e055131cbdfb6', class: "downloads-list", error: this.error }, index.h("span", { key: 'e964e638e118edd085fc6fdbbb1297d63b0c060b', slot: "heading" }, index.h("slot", { key: '05b0f1962e923af6709b7f56b5867e64762262bc', name: "heading" }, this.heading || wp.i18n.__('Items', 'surecart'))), index.h("slot", { key: '13807161723aecce3e79a48c856d2627e1ee529b', name: "before" }), !!this.allLink && (index.h("sc-button", { key: 'a559f10ac7791b5fe76eb366a30e5b66379b97e5', type: "link", href: this.allLink, slot: "end" }, wp.i18n.__('View all', 'surecart'), index.h("sc-icon", { key: 'f8f6598957786b83cc793ee4067abb2274f8112b', name: "chevron-right", slot: "suffix" }))), this.renderContent(), index.h("slot", { key: 'e4dd8a116f8eb384ab209649d8b641d511ee8c07', name: "after" }), this.busy && index.h("sc-block-ui", { key: '277bbe2cdfa0864d6a37231200ac7e3db40c9c5e' })));
    }
