...
const ScSelectDropdown = class {
    ...
    render() {
        var _a;
        return (index.h("div", { key: 'af44f7a10fcf9c3a0a0ad3def29ef18249797724', part: "base", class: {
                'select': true,
            ...
            } }, index.h("sc-form-control", { key: '68768572a5027e5d45e15c817484f8b5c370279b', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("input", { key: '23b14215beb2de6b93db935efed28e0e26a61dde', class: "select__hidden-input", name: this.name, ref: el => (this.input = el), value: this.value, required: this.required, disabled: this.disabled, "aria-hidden": "true", "aria-label": this.displayValue() || this.label || this.placeholder, onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus() }), index.h("sc-dropdown", { key: '5fdc144db7c31fffab2bfb6fc379d8046123aa7a', exportparts: "trigger, panel", disabled: this.disabled, open: this.open, closeOnSelect: this.closeOnSelect, position: this.position, placement: this.placement, hoist: this.hoist, style: { '--panel-width': '100%' }, onScShow: () => this.handleShow(), onScHide: () => this.handleHide(), role: "select", "aria-open": this.open ? 'true' : 'false' }, index.h("slot", { key: '0412c4a8dfc5f327318a333373a378d7c84656f8', name: "trigger", slot: "trigger" }, index.h("div", { key: '9b9b26ea86624356c1b0b7fb02c969eb954d3c47', class: "trigger", role: "button", tabIndex: -1, onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }, index.h("div", { key: '6bbce283edce2137f7838792f3f6fa91d6e8255f', class: "select__value" }, index.h("slot", { key: '1d5599e3895fb7b214c498e5652dc9852aa7d4a6' }, this.displayValue() || this.placeholder || wp.i18n.__('Select...', 'surecart'))), index.h("sc-icon", { key: 'a357ed721eecd7c2bd7133f4a4378ae936c656f4', exportparts: "base:caret", class: "select__caret", name: "chevron-down" }))), this.search && (index.h("sc-input", { key: '0b7837ef4705cd01d644fc810cb13d037b992d0a', exportparts: "base:search__base, input:search__input, form-control:search__form-control", placeholder: this.searchPlaceholder || wp.i18n.__('Search...', 'surecart'), onScInput: e => this.handleQuery(e), class: "search", clearable: true, part: "search", value: this.searchTerm, ref: el => (this.searchInput = el), "aria-label": wp.i18n.__('Type to search', 'surecart') }, this.loading && index.h("sc-spinner", { key: '8b3271b7f42f086a55dd3e56c28e1a5ea95e6d6f', exportparts: "base:spinner__base", style: { '--spinner-size': '0.5em' }, slot: "suffix" }))), index.h("sc-menu", { key: 'af0b2a9123432e7b535fe86263837a7e24601de8', style: { maxHeight: '210px', overflow: 'auto' }, exportparts: "base:menu__base", onScroll: e => this.handleMenuScroll(e), "aria-multiselectable": "false" }, index.h("slot", { key: '145a0817f12724d2b6b106263f2a906e15ee7558', name: "prefix" }), (this.filteredChoices || []).map((choice, index) => {
            return [this.renderItem(choice, index), (choice.choices || []).map(choice => this.renderItem(choice, index))];
        }), this.loading && (index.h("div", { key: '2bbfe89af75eb3293f1d795cc2e7015a815947ce', class: "loading" }, index.h("sc-spinner", { key: '3355f8d28a093c0f0fec24b48905b67838e7e9ea', exportparts: "base:spinner__base" }))), !this.loading && !this.filteredChoices.length && (index.h("div", { key: '2fa4fc3f816f3722678107293fba9067a6a14e47', class: "select__empty", part: "empty" }, wp.i18n.__('Nothing Found', 'surecart'))), index.h("slot", { key: '9792937be62b29764c22c7085a10b592edbf3010', name: "suffix" }))))));
    }
