...
const ScSelectDropdown = class {
    ...
    render() {
        var _a;
        return (index.h("div", { key: 'c1b57c20575596f705c24aa064c999fb077a947f', part: "base", class: {
                'select': true,
            ...
            } }, index.h("sc-form-control", { key: 'e19bcccd88569645c0317b3ecfddbfdbf5e245a7', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("input", { key: '64537bd079fc39ee274fb01dd0d43943da7baa9e', class: "select__hidden-input", name: this.name, ref: el => (this.input = el), value: this.value, required: this.required, disabled: this.disabled, "aria-hidden": "true", "aria-label": this.displayValue() || this.label || this.placeholder, onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus() }), index.h("sc-dropdown", { key: '818a74fd79301982a877a0a03413886f834a1a59', exportparts: "trigger, panel", disabled: this.disabled, open: this.open, closeOnSelect: this.closeOnSelect, position: this.position, placement: this.placement, hoist: this.hoist, style: { '--panel-width': '100%' }, onScShow: () => this.handleShow(), onScHide: () => this.handleHide(), role: "select", "aria-open": this.open ? 'true' : 'false' }, index.h("slot", { key: '83aedfcdd10beed76cc947c18ed827c4e643067d', name: "trigger", slot: "trigger" }, index.h("div", { key: 'bbd78a4bc5acb9f06cc9a34546afc4139e486487', class: "trigger", role: "button", tabIndex: -1, onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }, index.h("div", { key: '1a7ebe14d1ee446f113d4abdbbcb40f18216cf1d', class: "select__value" }, index.h("slot", { key: 'bd6c363e1b63456c7d697c6aa52841f3e786f9bc' }, this.displayValue() || this.placeholder || wp.i18n.__('Select...', 'surecart'))), index.h("sc-icon", { key: '52ef82d41ee13356482fbeafce74cb36a15649b9', exportparts: "base:caret", class: "select__caret", name: "chevron-down" }))), this.search && (index.h("sc-input", { key: '44cab43df8837cb2746a1e76fc6de58d1095ab76', exportparts: "base:search__base, input:search__input, form-control:search__form-control", placeholder: this.searchPlaceholder || wp.i18n.__('Search...', 'surecart'), onScInput: e => this.handleQuery(e), class: "search", clearable: true, part: "search", value: this.searchTerm, ref: el => (this.searchInput = el), "aria-label": wp.i18n.__('Type to search', 'surecart') }, this.loading && index.h("sc-spinner", { key: 'aa70a05d92a84018460dcf4ba7668586881b0056', exportparts: "base:spinner__base", style: { '--spinner-size': '0.5em' }, slot: "suffix" }))), index.h("sc-menu", { key: 'fb38b07848573bf9c03acfe6eddebb048cb1e63a', style: { maxHeight: '210px', overflow: 'auto' }, exportparts: "base:menu__base", onScroll: e => this.handleMenuScroll(e), "aria-multiselectable": "false" }, index.h("slot", { key: '6368a5fa7dc88faf0ad1bfecccfa34173f406773', name: "prefix" }), (this.filteredChoices || []).map((choice, index) => {
            return [this.renderItem(choice, index), (choice.choices || []).map(choice => this.renderItem(choice, index))];
        }), this.loading && (index.h("div", { key: 'b53f1ee0577545a9d9990f1a08c2dcf0e58aff5b', class: "loading" }, index.h("sc-spinner", { key: '7ade5d8aa1cc91de7a1b032829abde19cff93919', exportparts: "base:spinner__base" }))), !this.loading && !this.filteredChoices.length && (index.h("div", { key: 'f5fc5505dd1ea6759abb44f36b2fb32890338a20', class: "select__empty", part: "empty" }, wp.i18n.__('Nothing Found', 'surecart'))), index.h("slot", { key: 'bfb8980c040db1940ce19f3a4d0ba8e5a76ac7d0', name: "suffix" }))))));
    }
