...
const ScTab = class {
    ...
    render() {
        ...
        return (index.h(Tag, { key: '68df21c46eac59dd75123e45aae9688ec67e7a4c', part: `base ${this.active ? `active` : ``}`, href: this.href, class: {
                'tab': true,
            ...
            }, ref: el => (this.tab = el), role: "tab", "aria-disabled": this.disabled ? 'true' : 'false', "aria-selected": this.active ? 'true' : 'false', tabindex: this.disabled ? '-1' : '0' }, index.h("span", { key: '623c391874c2a91c16c1f4eaa45c5023fc2c7a49', part: "prefix", class: "tab__prefix" }, index.h("slot", { key: '08f21a11b654483254768e30cdbdedd36034d2fc', onSlotchange: () => this.handleSlotChange(), name: "prefix" })), index.h("div", { key: '8c538bbd55fb9ac4ebe1d806c2ee551884ea6238', class: "tab__content", part: "content" }, index.h("slot", { key: 'f2e0ba4183f28489dd3c4be2ba2fad6f8db1ee7f' })), index.h("span", { key: 'b52a7740ab78de3429965fc38a8e523461a0a7fc', part: "suffix", class: "tab__suffix" }, index.h("slot", { key: 'aaf78b3676c9ca867b9bee0840bfeac9d5b2f28b', onSlotchange: () => this.handleSlotChange(), name: "suffix" })), index.h("slot", { key: '6ee8c63850104996596bbf7f8a5a989196fc9c2b', name: "suffix" }, !!this.count && (index.h("div", { key: '044e4571bdc9707097d03f6bd5d1a0cfa90c27e7', class: "tab__counter", part: "counter" }, this.count)))));
    }
