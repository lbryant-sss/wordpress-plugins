...
const ScTabGroup = class {
    ...
    render() {
        return (index.h("div", { key: '6e64310a729481b6c4df2d3d8c6b7c9f855527ac', part: "base", class: {
                'tab-group': true,
            }, onClick: e => this.handleClick(e), onKeyDown: e => this.handleKeyDown(e) }, index.h("div", { key: 'dece4349ee664cc48506a26acf936ace1283713f', class: "tab-group__nav-container", part: "nav" }, index.h("div", { key: '07c7e17154801feba0f17d66a561b1054c9fb1ff', class: "tab-group__nav" }, index.h("div", { key: '4b6872cefab5c9867d0c0641c94bb50a431a291e', part: "tabs", class: "tab-group__tabs", role: "tablist" }, index.h("slot", { key: 'dc69ad02aa2908559476bb71afd587af5c8eff94', onSlotchange: () => this.syncTabsAndPanels(), name: "nav" })))), index.h("div", { key: '439b03013bb57fb176c5233c9e9b7ff75348a7d8', part: "body", class: "tab-group__body" }, index.h("slot", { key: 'c47afd01cf9e1389d94a990db98516ce1e91ab4f', onSlotchange: () => this.syncTabsAndPanels() }))));
    }
