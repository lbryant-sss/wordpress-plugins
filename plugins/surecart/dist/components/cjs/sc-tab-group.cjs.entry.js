...
const ScTabGroup = class {
    ...
    render() {
        return (index.h("div", { key: 'be00cbda9cb1df071c7e3538c3f1b7d7e3ea4669', part: "base", class: {
                'tab-group': true,
            }, onClick: e => this.handleClick(e), onKeyDown: e => this.handleKeyDown(e) }, index.h("div", { key: 'd09036530b4cea593d2e76811746fe174f5602c6', class: "tab-group__nav-container", part: "nav" }, index.h("div", { key: '2aab7b63260f27a3bb520c800e772e550980aa20', class: "tab-group__nav" }, index.h("div", { key: 'b9331dcbd41afbc3fcc5ab9487ae89d5ed816f88', part: "tabs", class: "tab-group__tabs", role: "tablist" }, index.h("slot", { key: 'd2440ba25acd0a72ea1e47e59d996ca910208a81', onSlotchange: () => this.syncTabsAndPanels(), name: "nav" })))), index.h("div", { key: '23cabf80d36dada3ede98dff55eef940fb0d0cae', part: "body", class: "tab-group__body" }, index.h("slot", { key: 'bee631373c4ccccb5b9398e1cce5a05cd430e70c', onSlotchange: () => this.syncTabsAndPanels() }))));
    }
