...
const ScPaypalAddMethod = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a968cf45d077b18ebff006f38cb8597da5e5fcf4' }, this.error && (index.h("sc-alert", { key: '3241b8402d8093caecb4f3c7a808147483010b87', open: !!this.error, type: "danger" }, index.h("span", { key: '3c9a0c14df714211b3c1dd3e06049ce3bca7d9c1', slot: "title" }, wp.i18n.__('Error', 'surecart')), this.error)), index.h("div", { key: '9515d027951e4e9bda354c0c862e4357041799bb', class: "sc-paypal-button-container", hidden: !this.loaded, ref: el => (this.container = el) })));
    }
