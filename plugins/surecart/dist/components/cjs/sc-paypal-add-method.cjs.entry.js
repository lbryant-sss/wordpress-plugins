...
const ScPaypalAddMethod = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5c4c0482bdb931c4db77b94fa1f57a7eeec7932c' }, this.error && (index.h("sc-alert", { key: '7651af264c272540ccac08d89bce42e31daa8e8d', open: !!this.error, type: "danger" }, index.h("span", { key: 'ab38d1c87ac96db7d4f4d3dd4176d6e368776472', slot: "title" }, wp.i18n.__('Error', 'surecart')), this.error)), index.h("div", { key: 'e91328ef3d7ad0cb1dd880d32cf600b9831fcb4e', class: "sc-paypal-button-container", hidden: !this.loaded, ref: el => (this.container = el) })));
    }
