...
const ScPaystackAddMethod = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7130f6f277c03ee6abdec29fec61db34d067fab0' }, this.error && (index.h("sc-alert", { key: 'eae44021b008865b2ba3f03ebc6e2bf30d7ef7d9', open: !!this.error, type: "danger" }, index.h("span", { key: 'e1d23e0d9f1e7136d30123f59ccbb829c6a9c3ad', slot: "title" }, wp.i18n.__('Error', 'surecart')), this.error)), index.h("div", { key: 'e5988c626d2d3364c0e7d277b9e9e6f56bf39a9f', class: "sc-paystack-button-container" }, index.h("sc-alert", { key: '86284b4060382753c69cb46c0ce46a3b3ab63c20', open: true, type: "warning" }, wp.i18n.__('In order to add a new card, we will need to make a small transaction to authenticate it. This is for authentication purposes and will be immediately refunded.', 'surecart'), index.h("div", { key: '99958a2b4b58e6263eb26ca7676b7e71832d3bf1' }, index.h("sc-button", { key: 'cfadb883bd9b359ecff77541ad39f76eb8b249fa', loading: this.loading, type: "primary", onClick: () => this.createPaymentIntent(), style: { marginTop: 'var(--sc-spacing-medium)' } }, wp.i18n.__('Add New Card', 'surecart')))))));
    }
