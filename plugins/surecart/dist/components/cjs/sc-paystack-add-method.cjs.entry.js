...
const ScPaystackAddMethod = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a6fe4ade877a1e21e779fc5e2a6965d74c0c70d6' }, this.error && (index.h("sc-alert", { key: '605ef3d61be311d4a34deeda616f5646d05e737a', open: !!this.error, type: "danger" }, index.h("span", { key: 'e2c18a712aae77ac16e09d83e856ce7e42502586', slot: "title" }, wp.i18n.__('Error', 'surecart')), this.error)), index.h("div", { key: 'e2bbca93e0de55ba33d11e3a20fadc09bc8f8d34', class: "sc-paystack-button-container" }, index.h("sc-alert", { key: 'c2b5a62a8b869de8fab5b875082a256e91425d88', open: true, type: "warning" }, wp.i18n.__('In order to add a new card, we will need to make a small transaction to authenticate it. This is for authentication purposes and will be immediately refunded.', 'surecart'), index.h("div", { key: '682c926ab47c61be6d22a32f0615d77a71147594' }, index.h("sc-button", { key: 'a6957b506ad336606f2d3eb6476c3ea2923feee8', loading: this.loading, type: "primary", onClick: () => this.createPaymentIntent(), style: { marginTop: 'var(--sc-spacing-medium)' } }, wp.i18n.__('Add New Card', 'surecart')))))));
    }
