...
const ScPassword = class {
    ...
    render() {
        var _a;
        return (index.h("div", { key: '55ab7eaa8755e8f436b405af4f0c01d00771a7cf', class: "password" }, index.h("div", { key: '3d9fcbca2b63700ed494b9249bd2dfd2d18e09a1' }, index.h("sc-input", { key: '53ac27dec111bf46f4d6d20987a44e22b5661161', ref: el => (this.input = el), label: this.label, help: this.help, autofocus: this.autofocus, placeholder: this.placeholder, showLabel: this.showLabel, size: this.size ? this.size : 'medium', type: "password", name: "password", value: this.value, required: this.required, disabled: this.disabled, onScInput: () => this.handleValidate() }), !!this.hintText && index.h("small", { key: '1a2afedcb00573fabe58ca0b420d62ccf83c9cb8', class: "password__hint" }, this.hintText)), this.confirmation && (index.h("div", { key: '78811e9afae5ab2c772269f4b4dddea7ac671a17' }, index.h("sc-input", { key: 'e9223e0c4c76c44d30a28f3e15b0bd5c4af658d8', ref: el => (this.confirmInput = el), label: (_a = this.confirmationLabel) !== null && _a !== void 0 ? _a : wp.i18n.__('Confirm Password', 'surecart'), help: this.confirmationHelp, placeholder: this.confirmationPlaceholder, size: this.size ? this.size : 'medium', type: "password", value: this.value, onScInput: () => this.handleVerification(), required: this.required, disabled: this.disabled }), !!this.verifyText && index.h("small", { key: '5ab42e539ed1a88f7f15f8added7beb1bb852e87', class: "password__hint" }, this.verifyText)))));
    }
