...
const ScStripePaymentElement = class {
    ...
    render() {
        return (index.h("div", { key: '638a2c4435eb37179bde3662be86f6328b03ab9d', class: "sc-stripe-payment-element", "data-testid": "stripe-payment-element" }, !!this.error && (index.h("sc-text", { key: '5818ef589db0e79c0ca31ed282a1da4ae13fac3a', style: {
                'color': 'var(--sc-color-danger-500)',
                '--font-size': 'var(--sc-font-size-small)',
                'marginBottom': '0.5em',
            } }, this.error)), index.h("div", { key: 'fb05259dc675480a2ccc8855938c5d55c53e06d4', class: "loader", hidden: this.loaded }, index.h("div", { key: '1a0925fa5d398efcf0ec2a19a7a276f2e775d345', class: "loader__row" }, index.h("div", { key: '8d08392e27112efdbc2cc5d70800ae1289bcf3c2', style: { width: '50%' } }, index.h("sc-skeleton", { key: '6e94c472619107ccd9b4690983367e5d9eb749b7', style: { width: '50%', marginBottom: '0.5em' } }), index.h("sc-skeleton", { key: 'b1cc82d1a8648a9f222c57725303d09b8e18c977' })), index.h("div", { key: '1952231caba575300ee3b4dc8f255af241f1907e', style: { flex: '1' } }, index.h("sc-skeleton", { key: 'e14e3b99d95ad0ed07757d95de65e17ba488d08f', style: { width: '50%', marginBottom: '0.5em' } }), index.h("sc-skeleton", { key: 'e371afeab1a75c30d0f794a5fcb82a1d859e61a5' })), index.h("div", { key: 'd1e6de3606ad2005d1b9de6724a0c3c66eb740d4', style: { flex: '1' } }, index.h("sc-skeleton", { key: '9911e279201280153c53edf6b431ae79ea63a93b', style: { width: '50%', marginBottom: '0.5em' } }), index.h("sc-skeleton", { key: '16dbe4f7595d1f80b6aacd011f7f512b4616c945' }))), index.h("div", { key: 'e9e80791bc6269903cb971628b630936811d40c8', class: "loader__details" }, index.h("sc-skeleton", { key: '97161624fa12b197f50ea83d578fd06e364281db', style: { height: '1rem' } }), index.h("sc-skeleton", { key: '1e86e0cc589b0e1449e921448e6b98289b86e975', style: { height: '1rem', width: '30%' } }))), index.h("div", { key: 'b79024afb7b78f8a00bbe0e3b85479b381778cad', hidden: !this.loaded, class: "sc-payment-element-container", ref: el => (this.container = el) })));
    }
