...
const ScTaxIdInput = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index$1.h(index$1.Fragment, { key: '49f285578041b1c1fa2a1bee457e5c1292113fe4' }, index$1.h("sc-input", { key: 'a19a150bd1099f102ae8a9d38daffac0fa6c97a1', name: "tax_identifier.number_type", required: this.required, value: this.type, style: { display: 'none' } }), index$1.h("sc-input", { key: '440ad9523d9ef0cecd524ee92e835ca3dc1fd295', ref: el => (this.input = el), label: this.getZoneLabel(), "aria-label": wp.i18n.__('Tax ID', 'surecart'), placeholder: wp.i18n.__('Enter Tax ID', 'surecart'), name: "tax_identifier.number", value: this.number, onScInput: (e) => {
