...
const ScCompactAddress = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h("div", { key: '4d1f21cb0615fc9712eb7f7ba6723739d3c6a971', class: "sc-address", part: "base" }, index.h("sc-form-control", { key: 'cd5d913296da01675cfd35ff17411bce194c42da', exportparts: "label, help-text, form-control", label: this.label, class: "sc-address__control", part: "control", required: this.required }, index.h("sc-select", { key: '511ed97df794fcfba482ff572696da36db7290c6', exportparts: "base:select__base, input, form-control, label, help-text, trigger, panel, caret, search__base, search__input, search__form-control, menu__base, spinner__base, empty", value: (_a = this.address) === null || _a === void 0 ? void 0 : _a.country, onScChange: (e) => {
                this.clearAddress();
                this.updateAddress({ country: e.target.value || null });
            }, choices: this.countryChoices, autocomplete: 'country-name', placeholder: ((_b = this.placeholders) === null || _b === void 0 ? void 0 : _b.country) || wp.i18n.__('Select Your Country', 'surecart'), name: this.names.country, search: true, unselect: false, "squared-bottom": this.showState || this.showPostal, required: this.required }), index.h("div", { key: 'eb46a4517037d310c10d75747bdad10bc4179d32', class: "sc-address__columns" }, this.showState && (index.h("sc-select", { key: '069d7dc97193de12cbb0a1a0ad352fd70879f8c5', exportparts: "base:select__base, input, form-control, label, help-text, trigger, panel, caret, search__base, search__input, search__form-control, menu__base, spinner__base, empty", placeholder: this.getStatePlaceholder(), name: this.names.state, autocomplete: 'address-level1', value: (_c = this === null || this === void 0 ? void 0 : this.address) === null || _c === void 0 ? void 0 : _c.state, onScChange: (e) => this.updateAddress({ state: e.target.value || null }), choices: this.regions, required: this.required, search: true, "squared-top": true, unselect: false, "squared-right": this.showPostal })), this.showPostal && (index.h("sc-input", { key: 'c22e0304313abc0f42e28439a27ce7fceed8083e', exportparts: "base:input__base, input, form-control, label, help-text", placeholder: ((_d = this.placeholders) === null || _d === void 0 ? void 0 : _d.postal_code) || wp.i18n.__('Postal Code/Zip', 'surecart'), name: this.names.postal_code, onScChange: (e) => this.updateAddress({ postal_code: e.target.value || null }), onScInput: (e) => this.handleAddressInput({ name: e.target.value || null }), autocomplete: 'postal-code', required: this.required, value: (_e = this === null || this === void 0 ? void 0 : this.address) === null || _e === void 0 ? void 0 : _e.postal_code, "squared-top": true, maxlength: 5, "squared-left": this.showState })))), this.loading && index.h("sc-block-ui", { key: 'f9107b81ac3dbeb6beea4e62e3b98d78f28e89d6', exportparts: "base:block-ui, content:block-ui__content" })));
    }
...
const ScRadio = class {
    ...
    render() {
        ...
        return (index.h(Tag, { key: 'd29acb70009d7dede4f7611df296fd97208984f5', part: "base", class: {
                'radio': true,
                'radio--checked': this.checked,
                'radio--disabled': this.disabled,
                'radio--focused': this.hasFocus,
                'radio--editing': this.edit,
            }, htmlFor: this.inputId, onKeyDown: e => this.handleKeyDown(e), onMouseDown: e => this.handleMouseDown(e) }, index.h("span", { key: '860a7cba17280b5fb3f59bdf614722fa6b9d653d', part: "control", class: "radio__control" }, index.h("span", { key: 'bfe2a7c50db2dc8c439c7078cfdc495dceb1a5b5', part: "checked-icon", class: "radio__icon" }, index.h("svg", { key: 'c65a231ab63e5d1639139fb86278529628d90a74', viewBox: "0 0 16 16" }, index.h("g", { key: '1ac087fcbd26fc2b1e62ad4282337cb53d36fcd9', stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd" }, index.h("g", { key: 'd5dbaba87d1717a36730eaa63d01d8a7fcca887a', fill: "currentColor" }, index.h("circle", { key: 'c2bdc45558994a8016c4537429508dbc16edf165', cx: "8", cy: "8", r: "3.42857143" }))))), index.h("input", { key: 'f1715e51d455054e9c7626ed3da7b9eee07793a4', id: this.inputId, ref: el => (this.input = el), type: "radio", name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, required: this.required, "aria-checked": this.checked ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', "aria-labelledby": this.labelId, onClick: () => this.handleClick(), onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus() })), index.h("span", { key: '067293d0ff387fadd4348d7a93ccce4830d2bc05', part: "label", id: this.labelId, class: "radio__label" }, index.h("slot", { key: 'c2a889eff5a65b4985b7f511860c2a5bf349b566' }), index.h("slot", { key: 'f4038f6be5117ac78bc5ac2578a77fa1f2e924fa', name: "description" }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const ScRadioGroup = class {
    ...
    render() {
        return (index.h("fieldset", { key: '2d8295cff9624e50ff487db2e452cc1a559fca4b', part: "base", class: {
                'radio-group': true,
                'radio-group--invalid': this.invalid,
                'radio-group--is-required': this.required,
                'radio-group--is-rtl': pageAlign.isRtl(),
            }, "aria-invalid": this.invalid, role: "radiogroup" }, index.h("legend", { key: '74e769d630fa5467592a22b8eb9306afccc08d7e', part: "label", class: "radio-group__label" }, index.h("slot", { key: 'cace73797c92f00e8dbc2b89a60e06b73c806428', name: "label" }, this.label)), index.h("input", { key: '51dd6dbda886bfbaeb8cd2d6aa14eb40c26c81b5', type: "text", class: "radio-group__hidden-input", ref: el => (this.input = el), required: this.required, value: this.value, tabindex: "-1" }), index.h("div", { key: '313f627e48421a993e5c57b352b1e3cf16e9dac7', part: "items", class: "radio-group__items" }, index.h("slot", { key: '195c8154904866244fc502cf09e3441b4e802c6c' }))));
    }
    get el() { return index.getElement(this); }
};
