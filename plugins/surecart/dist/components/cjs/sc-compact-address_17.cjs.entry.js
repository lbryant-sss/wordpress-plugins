...
const ScCompactAddress = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h("div", { key: '3e810d647a823a30b49a7a876fae3d696735d557', class: "sc-address", part: "base" }, index.h("sc-form-control", { key: '0cb5dee6a9a43e2db919ea216877e9a0224819fc', exportparts: "label, help-text, form-control", label: this.label, class: "sc-address__control", part: "control", required: this.required }, index.h("sc-select", { key: '93087fd60e016d9c82fe9e2664119d497e7f0051', exportparts: "base:select__base, input, form-control, label, help-text, trigger, panel, caret, search__base, search__input, search__form-control, menu__base, spinner__base, empty", value: (_a = this.address) === null || _a === void 0 ? void 0 : _a.country, onScChange: (e) => {
                this.clearAddress();
                this.updateAddress({ country: e.target.value || null });
            }, choices: this.countryChoices, autocomplete: 'country-name', placeholder: ((_b = this.placeholders) === null || _b === void 0 ? void 0 : _b.country) || wp.i18n.__('Select Your Country', 'surecart'), name: this.names.country, search: true, unselect: false, "squared-bottom": this.showState || this.showPostal, required: this.required }), index.h("div", { key: '2cb76ebe37248fbc3e6cb33b77430eb5bd8252ac', class: "sc-address__columns" }, this.showState && (index.h("sc-select", { key: '683bb371f5f7b29a72ea89c809fa8882245bd40c', exportparts: "base:select__base, input, form-control, label, help-text, trigger, panel, caret, search__base, search__input, search__form-control, menu__base, spinner__base, empty", placeholder: this.getStatePlaceholder(), name: this.names.state, autocomplete: 'address-level1', value: (_c = this === null || this === void 0 ? void 0 : this.address) === null || _c === void 0 ? void 0 : _c.state, onScChange: (e) => this.updateAddress({ state: e.target.value || null }), choices: this.regions, required: this.required, search: true, "squared-top": true, unselect: false, "squared-right": this.showPostal })), this.showPostal && (index.h("sc-input", { key: '6434e11e4e7fdb98d415a2c07fa060d1c1060644', exportparts: "base:input__base, input, form-control, label, help-text", placeholder: ((_d = this.placeholders) === null || _d === void 0 ? void 0 : _d.postal_code) || wp.i18n.__('Postal Code/Zip', 'surecart'), name: this.names.postal_code, onScChange: (e) => this.updateAddress({ postal_code: e.target.value || null }), onScInput: (e) => this.handleAddressInput({ name: e.target.value || null }), autocomplete: 'postal-code', required: this.required, value: (_e = this === null || this === void 0 ? void 0 : this.address) === null || _e === void 0 ? void 0 : _e.postal_code, "squared-top": true, maxlength: 5, "squared-left": this.showState })))), this.loading && index.h("sc-block-ui", { key: '8312df2cac4b4ace338f6a647195c403e874366e', exportparts: "base:block-ui, content:block-ui__content" })));
    }
...
const ScRadio = class {
    ...
    render() {
        ...
        return (index.h(Tag, { key: 'afefed90fff7e57de9cd2e542432092cb17fd794', part: "base", class: {
                'radio': true,
                'radio--checked': this.checked,
                'radio--disabled': this.disabled,
                'radio--focused': this.hasFocus,
                'radio--editing': this.edit,
            }, htmlFor: this.inputId, onKeyDown: e => this.handleKeyDown(e), onMouseDown: e => this.handleMouseDown(e) }, index.h("span", { key: 'b97a061f615532b51d2a63de4e18fc847fd1dd98', part: "control", class: "radio__control" }, index.h("span", { key: '8740558f8ade454447907d16a6ee242f6d7d8623', part: "checked-icon", class: "radio__icon" }, index.h("svg", { key: 'ffb3b0b56008886fee863381802dae3c75e08080', viewBox: "0 0 16 16" }, index.h("g", { key: '5098e30624f79bd5ca1d6b0f63cb4a83e33748d6', stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd" }, index.h("g", { key: 'de5476023510deecc176a23995702f4f2cb80480', fill: "currentColor" }, index.h("circle", { key: '2c68755bf8fdc0e832af07a1fdee9b137944f79c', cx: "8", cy: "8", r: "3.42857143" }))))), index.h("input", { key: '50ed06851196d1667f300bf320cc41aa074deda4', id: this.inputId, ref: el => (this.input = el), type: "radio", name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, required: this.required, "aria-checked": this.checked ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', "aria-labelledby": this.labelId, onClick: () => this.handleClick(), onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus() })), index.h("span", { key: '2e93101c85136a69a254598af1d9c63bbcfbf99b', part: "label", id: this.labelId, class: "radio__label" }, index.h("slot", { key: '8b9c474e6d594fb0fd4bd4b00e460b49cb4e0e21' }), index.h("slot", { key: 'd85e068664ef9d65b0aafec5e3306318f74595ea', name: "description" }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const ScRadioGroup = class {
    ...
    render() {
        return (index.h("fieldset", { key: 'e5ad6f26b70c6a0249cc3253f67d6c50e9422d55', part: "base", class: {
                'radio-group': true,
                'radio-group--invalid': this.invalid,
                'radio-group--is-required': this.required,
                'radio-group--is-rtl': pageAlign.isRtl(),
            }, "aria-invalid": this.invalid, role: "radiogroup" }, index.h("legend", { key: '6684e9aba7a69d1c188de7e13b121dab96fad2e5', part: "label", class: "radio-group__label" }, index.h("slot", { key: '2797543072b81b089ae1f47e10c1c65a1d8a871c', name: "label" }, this.label)), index.h("input", { key: '1508bee27e9f965a5677db0e003d69745ef314f4', type: "text", class: "radio-group__hidden-input", ref: el => (this.input = el), required: this.required, value: this.value, tabindex: "-1" }), index.h("div", { key: 'b101c35dbae24baaa5358b0eca674ed4675aecbc', part: "items", class: "radio-group__items" }, index.h("slot", { key: '70ae300f7073a73066de710ce6205d13970e8fbb' }))));
    }
    get el() { return index.getElement(this); }
};
