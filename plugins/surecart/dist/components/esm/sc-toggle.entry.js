...
const ScToggle = class {
    ...
    render() {
        return (h("div", { key: '4f7e60e13082b6bc381ecb488de64902813fe88a', part: "base", class: {
                'details': true,
            ...
            } }, h("header", { key: 'dc48114172a3cac02c86eaebb3956728ed72bd10', ref: el => (this.header = el), part: "header", id: "header", class: "details__header", role: "button", "aria-expanded": this.open ? 'true' : 'false', "aria-controls": "content", "aria-disabled": this.disabled ? 'true' : 'false', tabindex: this.disabled ? '-1' : '0', onClick: () => this.handleSummaryClick(), onKeyDown: e => this.handleSummaryKeyDown(e) }, this.showControl && (h("span", { key: 'b2ea60e40c832d913b48daa49aa0a7d45143d268', part: "radio", class: "details__radio" }, h("svg", { key: 'b4d2f6a27c269402ad34a4bd457823ec466c4b76', viewBox: "0 0 16 16" }, h("g", { key: 'ca54f1a897447a44673acf5ec2798d9e623ff99b', stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd" }, h("g", { key: 'fde41771e1fa16c542dc4d9896a6314fd1689962', fill: "currentColor" }, h("circle", { key: 'fba9474f2a4bd98a7529397c3f2ed663915c2550', cx: "8", cy: "8", r: "3.42857143" })))))), h("div", { key: '61bb920a0db6c3318aac00d64286ac3a1a8ed415', part: "summary", class: "details__summary" }, h("slot", { key: '2d30b79bea39f49db200dce124d791d3dfe05e4c', name: "summary" }, this.summary)), this.showIcon && (h("span", { key: '5c329e78aa42b86690661aa9c9ec428a9fcc81ec', part: "summary-icon", class: "details__summary-icon" }, h("slot", { key: 'bc0cb13335a2d39fcc80c192d6fe78fe7ac305eb', name: "icon" }, h("sc-icon", { key: '7a2fff29d5f344d11f4993e4d2ba45edff6c80c9', name: "chevron-right" }))))), h("div", { key: '35544000f0eca7aa7ac62d7e5f3c121284a0aa2c', class: "details__body", ref: el => (this.body = el), part: "body" }, h("div", { key: '86673fe7e01eb8a375f00eebc269d0be912b3e7e', part: "content", id: "content", class: "details__content", role: "region", "aria-labelledby": "header" }, h("slot", { key: '5cda0c1279b610b7777ab928eb36abc255d68fcb' })))));
    }
