...
const ScPurchaseDownloadsList = class {
    ...
    render() {
        return (h("sc-dashboard-module", { key: '8a29b05cba17431b07c74f54a0acaecfcb82f666', class: "downloads-list", error: this.error }, h("span", { key: '3767b6e54d621fa412e18f6a8700cabaa6d2adff', slot: "heading" }, h("slot", { key: '510cc1cf3d54c7b030d463f49a1f2ad165273e87', name: "heading" }, this.heading || wp.i18n.__('Items', 'surecart'))), h("slot", { key: 'e11cfec692ef3e767f532b5f43984b0e3bdbac30', name: "before" }), !!this.allLink && (h("sc-button", { key: 'b85a50c356769213c2d7c4d7a234cb87048ef477', type: "link", href: this.allLink, slot: "end" }, wp.i18n.__('View all', 'surecart'), h("sc-icon", { key: '4563f0489c90be8a951c62ccc7c40d744a90ede3', name: "chevron-right", slot: "suffix" }))), this.renderContent(), h("slot", { key: 'cf64118474f699b8ca39758ad7cbad0b8865b999', name: "after" }), this.busy && h("sc-block-ui", { key: 'b071ee482c5fd38b6f44182f757f005c11ad1aba' })));
    }
