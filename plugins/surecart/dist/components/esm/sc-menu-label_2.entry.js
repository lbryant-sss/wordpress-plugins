...
const ScSelectDropdown = class {
    ...
    render() {
        var _a;
        return (h("div", { key: '4a9328ad0ca16e29852853bdebd325231c7fe7ed', part: "base", class: {
                'select': true,
            ...
            } }, h("sc-form-control", { key: '3fb6119f955ce5a595b6da29d9e8c2cfc412abb5', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, h("input", { key: '1c5119e65a6408c0a6df08720e0874282902528f', class: "select__hidden-input", name: this.name, ref: el => (this.input = el), value: this.value, required: this.required, disabled: this.disabled, "aria-hidden": "true", "aria-label": this.displayValue() || this.label || this.placeholder, onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus() }), h("sc-dropdown", { key: '67e25ade616e830ab964e1ff29cec30fcae416ad', exportparts: "trigger, panel", disabled: this.disabled, open: this.open, closeOnSelect: this.closeOnSelect, position: this.position, placement: this.placement, hoist: this.hoist, style: { '--panel-width': '100%' }, onScShow: () => this.handleShow(), onScHide: () => this.handleHide(), role: "select", "aria-open": this.open ? 'true' : 'false' }, h("slot", { key: 'b0c696cdac2518e1baeecc0492bb34a2f500e12e', name: "trigger", slot: "trigger" }, h("div", { key: '49a696f6eb65b7dc90813787a769af471b0d4da4', class: "trigger", role: "button", tabIndex: -1, onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }, h("div", { key: '574a1d91468ea2233dd77f2a34870d05eef8461a', class: "select__value" }, h("slot", { key: 'ebed522c59b4a50d7c2d9ed0f0f79f61bbd2947e' }, this.displayValue() || this.placeholder || wp.i18n.__('Select...', 'surecart'))), h("sc-icon", { key: 'b6ba6734f2e5b384c491167ee97dbece089c9552', exportparts: "base:caret", class: "select__caret", name: "chevron-down" }))), this.search && (h("sc-input", { key: '2b2deae9dec74375b97a6c48af1aaabe5be0fd97', exportparts: "base:search__base, input:search__input, form-control:search__form-control", placeholder: this.searchPlaceholder || wp.i18n.__('Search...', 'surecart'), onScInput: e => this.handleQuery(e), class: "search", clearable: true, part: "search", value: this.searchTerm, ref: el => (this.searchInput = el), "aria-label": wp.i18n.__('Type to search', 'surecart') }, this.loading && h("sc-spinner", { key: '322826e1b17a0c6d52dbd9d0ce74e1c2574736f7', exportparts: "base:spinner__base", style: { '--spinner-size': '0.5em' }, slot: "suffix" }))), h("sc-menu", { key: 'fba0c7b322daf5680ddfd294c6abc02479e4e4fb', style: { maxHeight: '210px', overflow: 'auto' }, exportparts: "base:menu__base", onScroll: e => this.handleMenuScroll(e), "aria-multiselectable": "false" }, h("slot", { key: '85724a25a02f27595ef563bb320c55072d0ba557', name: "prefix" }), (this.filteredChoices || []).map((choice, index) => {
            return [this.renderItem(choice, index), (choice.choices || []).map(choice => this.renderItem(choice, index))];
        }), this.loading && (h("div", { key: 'e44333f077ffa624727dc6cb7071c551e61d2113', class: "loading" }, h("sc-spinner", { key: '8a751380cd96ff8bdb90f2bdfeec63e1f3e11f7e', exportparts: "base:spinner__base" }))), !this.loading && !this.filteredChoices.length && (h("div", { key: 'be2448dd6f5ff9c0b1ee65a9fff45843a67203ef', class: "select__empty", part: "empty" }, wp.i18n.__('Nothing Found', 'surecart'))), h("slot", { key: 'cd98dc27aec5a52fc7b32301bd23301abc94702f', name: "suffix" }))))));
    }
