...
const ScUpcomingInvoice = class {
    ...
    render() {
        return (h("div", { key: 'd86dcf12f5669ed80b4c7a4465f7a3e44b43772f', class: "upcoming-invoice" }, this.error && (h("sc-alert", { key: '492a676b71d82634800f2f5f731cfed7c1b30875', open: !!this.error, type: "danger" }, h("span", { key: '92fe50b97642a77891b5d5dd0543b67e40596492', slot: "title" }, wp.i18n.__('Error', 'surecart')), this.error)), h(Fragment, { key: 'a1b87d62b601ef953651d801136ee500380d6729' }, h("sc-dashboard-module", { key: '2bb9db971b252fa5238698bfe9a87acea804bfb2', heading: wp.i18n.__('New Plan', 'surecart'), class: "plan-preview", error: this.error }, h("sc-card", { key: '536b64c78c3e47f76f962252f9836c1a46e8e41e' }, this.renderContent())), h("sc-dashboard-module", { key: '19df8d7eaefd61c9279ce3a64775814373a93485', heading: wp.i18n.__('Summary', 'surecart'), class: "plan-summary" }, h("sc-form", { key: 'a93ef00d7f8d643af165a3945d9c83f5b0848f70', onScFormSubmit: () => this.onSubmit() }, h("sc-card", { key: '0146ac3dfaedb88b934d0c686f14229455a12ae6' }, this.renderSummary()), h("sc-button", { key: '6bfab73a8f05d3de663b866236ca5137b784d8ec', type: "primary", full: true, submit: true, loading: this.loading || this.busy, disabled: this.loading || this.busy }, wp.i18n.__('Confirm', 'surecart')))), h("sc-text", { key: '83cf9631577a0024899792d98da600ff9aeb8574', style: { '--text-align': 'center', '--font-size': 'var(--sc-font-size-small)', '--line-height': 'var(--sc-line-height-normal)' } }, h("slot", { key: '412a715718f9dfb9a27098a4f5f13cf7a4c1376c', name: "terms" }))), this.busy && h("sc-block-ui", { key: '7c6686b812325a6dff244897f5509ec071c6fe0b' })));
    }
