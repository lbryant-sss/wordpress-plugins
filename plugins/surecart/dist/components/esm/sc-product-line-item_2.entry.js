...
const ScProductLineItem = class {
    ...
    render() {
        var _a, _b;
        return (h("div", { key: '8a961447af513713f0e42625479d548433fe6a1d', class: "base", part: "base" }, h("div", { key: 'e92fd0785e96dba3d0366f8b4d33c09c3995fb4f', part: "product-line-item", class: {
                'item': true,
            ...
            } }, !!((_b = this.image) === null || _b === void 0 ? void 0 : _b.src) && h("img", { key: 'a941ba2d6f707ce24ef298529ff4d44141f75b20', ...this.image, part: "image" }), h("div", { key: 'ba90e0cae5d40e7306a13f28c6d68d58ac6e3e7c', class: "item__text", part: "text" }, h("div", { key: 'e2a932ea9260bb7ffefd368dc74246e575d0dfd0', class: "item__text-details" }, h("div", { key: 'a8c50683541fcfafc6464d803772885a0ab102ab', class: "item__title", part: "title" }, h("slot", { key: '264c22be69ea4e2ca4768abe43614c55eecfea26', name: "title" }, this.name)), h("div", { key: '7e7f57281a160afaab6e10d6c02d92077471c914', class: "item__description item__price-variant", part: "description" }, h("div", { key: 'e844efeb978c3527989aacfc259d485b4f1a68dd' }, this.variantLabel), h("div", { key: 'd329ad83878a1abaad81bbd2af3ed479b8046ed0' }, this.priceName), !!this.sku && (h("div", { key: '04eb3935027ecd58233e51a95db968049eba8d2c' }, wp.i18n.__('SKU:', 'surecart'), " ", this.sku))), !this.editable && this.quantity > 1 && (h("span", { key: '05baaaff73bfe1e28e4edad7dab0d57325d27ce9', class: "item__description", part: "static-quantity" }, wp.i18n.__('Qty:', 'surecart'), " ", this.quantity))), this.editable && (h("sc-quantity-select", { key: '3c00487a256de96a255c96b1def9d1287f60387c', max: this.max || Infinity, exportparts: "base:quantity, minus:quantity__minus, minus-icon:quantity__minus-icon, plus:quantity__plus, plus-icon:quantity__plus-icon, input:quantity__input", clickEl: this.el, quantity: this.quantity, size: "small", onScChange: e => e.detail && this.scUpdateQuantity.emit(e.detail), "aria-label": 
            /** translators: %1$s: product name, %2$s: product price name */
            wp.i18n.sprintf(wp.i18n.__('Change Quantity - %1$s %2$s', 'surecart'), this.name, this.priceName) }))), h("div", { key: 'ca7896350a33abeef6ed7ce8debc0dc6e796f2ba', class: "item__suffix", part: "suffix" }, this.removable ? (h("sc-icon", { exportparts: "base:remove-icon__base", class: "item__remove", name: "x", onClick: () => this.scRemove.emit(), onKeyDown: e => {
                if (e.key === 'Enter') {
                    this.scRemove.emit();
                }
...
const ScQuantitySelect = class {
    ...
    render() {
        return (h("div", { key: '4c88be4996b28c303b9fe039a0c5f5dc84e868d1', part: "base", class: {
                'quantity': true,
                // States
            ...
            } }, h("button", { key: '5411d1fa3216cd4a400832053e4dd9ecaf2d978b', part: "minus", "aria-label": wp.i18n.__('Decrease quantity by one.', 'surecart'), "aria-disabled": this.disabled || (this.quantity <= this.min && this.min > 1), class: { 'button__decrease': true, 'button--disabled': this.quantity <= this.min && this.min > 1 }, onClick: () => this.quantity > this.min && this.decrease(), disabled: this.disabled || (this.quantity <= this.min && this.min > 1) }, h("sc-icon", { key: '6222fc4b074566e229f35aaf68c31b365e91e375', name: "minus", exportparts: "base:minus__icon" })), h("input", { key: 'cf1a99ff4f5cf4aa3019b69e701c03611f0796c5', part: "input", class: "input__control", ref: el => (this.input = el), step: "1", type: "number", max: this.max, min: this.min, value: this.quantity, disabled: this.disabled, autocomplete: "off", role: "spinbutton", "aria-valuemax": this.max, "aria-valuemin": this.min, "aria-valuenow": this.quantity, "aria-disabled": this.disabled, onChange: () => this.handleChange(), onInput: () => this.handleInput(), onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }), h("button", { key: 'd2205281951deb01498b509feb3799f69302763c', part: "plus", "aria-label": wp.i18n.__('Increase quantity by one.', 'surecart'), class: { 'button__increase': true, 'button--disabled': this.quantity >= this.max }, onClick: () => this.quantity < this.max && this.increase(), "aria-disabled": this.disabled || this.quantity >= this.max, disabled: this.disabled || this.quantity >= this.max }, h("sc-icon", { key: 'f2fd114c8e363284a6191163bb852c30d00e1c0d', name: "plus", exportparts: "base:plus__icon" }))));
    }
    get el() { return getElement(this); }
};
