...
const ScPassword = class {
    ...
    render() {
        var _a;
        return (h("div", { key: 'e5d8537a8790daea739ace05e60cbe2d682aafd7', class: "password" }, h("div", { key: '587d203145fae3e1ac79901e6d4c435e2c9052e3' }, h("sc-input", { key: 'd6365e46fb9f9d3458c570a940672251d33d602c', ref: el => (this.input = el), label: this.label, help: this.help, autofocus: this.autofocus, placeholder: this.placeholder, showLabel: this.showLabel, size: this.size ? this.size : 'medium', type: "password", name: "password", value: this.value, required: this.required, disabled: this.disabled, onScInput: () => this.handleValidate() }), !!this.hintText && h("small", { key: '263483dcd82d0f16fb7759cabdca515f25a32c68', class: "password__hint" }, this.hintText)), this.confirmation && (h("div", { key: '448d4eb501f9914b2ae603682bc3212f6fffbd5b' }, h("sc-input", { key: 'a3d6cece49a7705e27660248934e0f6e6d011889', ref: el => (this.confirmInput = el), label: (_a = this.confirmationLabel) !== null && _a !== void 0 ? _a : wp.i18n.__('Confirm Password', 'surecart'), help: this.confirmationHelp, placeholder: this.confirmationPlaceholder, size: this.size ? this.size : 'medium', type: "password", value: this.value, onScInput: () => this.handleVerification(), required: this.required, disabled: this.disabled }), !!this.verifyText && h("small", { key: '9786c8ad9a8428b2a28879cd8d7ea3491b95eb49', class: "password__hint" }, this.verifyText)))));
    }
