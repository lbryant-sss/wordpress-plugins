...
const ScSwitch = class {
    ...
    render() {
        ...
        return (h(Tag, { key: '4ec56330e36e16dcd109df508fcc2029b20b4a8d', part: "base", htmlFor: this.switchId, class: {
                'switch': true,
            ...
            }, onMouseDown: e => this.handleMouseDown(e) }, h("span", { key: 'ec94bbe3c9a3b0457c1ec281a5853d2aa4c4e96c', part: "control", class: "switch__control" }, h("span", { key: '1fa7d2e1e3ffec5622d97a3b69612e15ce3e0153', part: "thumb", class: "switch__thumb" }), h("input", { key: '41977356b39ddc43229e672ae9a9cdb06d2288f4', ref: el => (this.input = el), id: this.switchId, type: "checkbox", role: "switch", name: this.name, value: this.value || 'on', checked: this.checked, disabled: this.disabled, required: this.required, "aria-checked": this.checked ? 'true' : 'false', "aria-labelledby": this.labelId, onClick: () => this.handleClick(), onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus(), onKeyDown: e => this.handleKeyDown(e) })), h("span", { key: '028b6c7468a6ca8f2b95d986a258e6b6d945e738', class: "switch__label" }, h("span", { key: 'a194ab96346f5097802222f7191e788d086fa46d', part: "title", id: this.labelId, class: "switch__title" }, h("slot", { key: '1f0a024b0fb3a993557b211b592939d786fcd4ee' })), h("span", { key: '85c8399374b2f147ba408cbd7d95ceeb1a607956', class: "switch__description", part: "description" }, h("slot", { key: 'cead533fc441a409e32e114a120d168a712e16a3', name: "description" })))));
    }
