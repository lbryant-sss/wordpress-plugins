...
const ScProvisionalBanner = class {
    ...
    render() {
        return (h("div", { key: '616fd32b9e782380b72df3ffe0f8be85c0fac695', class: { 'sc-banner': true } }, h("p", { key: '1b7d14bb0596313a2868f6a470d584540e556c3b' }, wp.i18n.__('Complete your store setup to go live.', 'surecart'), h("a", { key: 'd4769f098e3ba2879ef1e1aca5ce23ab07849330', href: this.claimUrl }, wp.i18n.__('Complete Setup', 'surecart'), " ", h("sc-icon", { key: 'c3e7b2e226579bb63ab21a80454403d57fa8a414', name: "arrow-right" })))));
    }
};
