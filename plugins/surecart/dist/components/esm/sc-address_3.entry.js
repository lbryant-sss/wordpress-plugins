...
const ScTaxIdInput = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (h(Fragment, { key: '5df792e7db591f51626cbd4fbaf8d114b49ed3b7' }, h("sc-input", { key: '255543dbf854a6ca0f1833e8e837476d73eade17', name: "tax_identifier.number_type", required: this.required, value: this.type, style: { display: 'none' } }), h("sc-input", { key: '8558a3ab618034e3139aa102db620d85091e627f', ref: el => (this.input = el), label: this.getZoneLabel(), "aria-label": wp.i18n.__('Tax ID', 'surecart'), placeholder: wp.i18n.__('Enter Tax ID', 'surecart'), name: "tax_identifier.number", value: this.number, onScInput: (e) => {
