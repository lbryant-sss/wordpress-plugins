...
const ScSubscription = class {
    ...
    render() {
        ...
        return (h("sc-dashboard-module", { key: '58d0dde7c1059b301a63ef6ca0870585d2cd5e4e', heading: this.heading || wp.i18n.__('Current Plan', 'surecart'), class: "subscription", error: this.error }, !!this.subscription && (h("sc-flex", { key: 'a10d0e0a2a349de76d080524da9bfa572562a752', slot: "end", class: "subscription__action-buttons" }, this.updatePaymentMethodUrl && paymentMethodExists && (h("sc-button", { key: 'a64192f1c6e5013b56942ae2ed954a5e06d6a6b6', type: "link", href: this.updatePaymentMethodUrl }, h("sc-icon", { key: 'a8780535678e8dc3fe9a6e194f97bc21d7dc8f8b', name: "credit-card", slot: "prefix" }), wp.i18n.__('Update Payment Method', 'surecart'))), !paymentMethodExists && (h("sc-button", { key: '71c741aba69962227b58637c69e23312b870de5b', type: "link", href: addQueryArgs(window.location.href, {
                action: 'create',
            ...
            }) }, h("sc-icon", { key: '6d941b076ac29dfdb76356df04d8fdff4affb99a', name: "credit-card", slot: "prefix" }), wp.i18n.__('Add Payment Method', 'surecart'))), !!Object.keys((_b = this.subscription) === null || _b === void 0 ? void 0 : _b.pending_update).length && (h("sc-button", { key: 'f4edeb7a766d67bc4b59f879bce27648aa77872a', type: "link", onClick: () => this.cancelPendingUpdate() }, h("sc-icon", { key: '568aa82010fab84e41f9f804151a2bf345ddd8b5', name: "x-octagon", slot: "prefix" }), wp.i18n.__('Cancel Scheduled Update', 'surecart'))), ((_c = this === null || this === void 0 ? void 0 : this.subscription) === null || _c === void 0 ? void 0 : _c.cancel_at_period_end) ? (h("sc-button", { type: "link", onClick: () => this.renewSubscription() }, h("sc-icon", { name: "repeat", slot: "prefix" }), wp.i18n.__('Restore Plan', 'surecart'))) : (((_d = this.subscription) === null || _d === void 0 ? void 0 : _d.status) !== 'canceled' &&
            ((_e = this.subscription) === null || _e === void 0 ? void 0 : _e.current_period_end_at) &&
            this.showCancel && (h("sc-button", { type: "link", onClick: () => (this.cancelModal = true) }, h("sc-icon", { name: "x", slot: "prefix" }), wp.i18n.__('Cancel Plan', 'surecart')))), ((_f = this.subscription) === null || _f === void 0 ? void 0 : _f.status) === 'canceled' && (h("sc-button", { key: '3a53995e7f4c1bc2d2c27646bb3e2f187499a233', type: "link", ...(!!((_g = this.subscription) === null || _g === void 0 ? void 0 : _g.payment_method) || (this === null || this === void 0 ? void 0 : this.subscription.manual_payment)
                ? {
                    onClick: () => (this.resubscribeModal = true),
                }
                : {
                    href: this === null || this === void 0 ? void 0 : this.updatePaymentMethodUrl,
                }) }, h("sc-icon", { key: '81409b305d490e0a008f547b2eb0de502560f44e', name: "repeat", slot: "prefix" }), wp.i18n.__('Resubscribe', 'surecart'))))), h("sc-card", { key: '3dc673e6d8b8f3a963de764bce12668b75a31fb7', style: { '--overflow': 'hidden' }, noPadding: true }, this.renderContent()), this.busy && h("sc-block-ui", { key: 'f66b5d48fe4422dcc90439ebc4a5b9a627753714', spinner: true }), h("sc-cancel-dialog", { key: '876bc89eb4f2a20b62b13ddeefb123b8bcc468a7', subscription: this.subscription, protocol: this.protocol, open: this.cancelModal, onScRequestClose: () => (this.cancelModal = false), onScRefresh: () => this.getSubscription() }), h("sc-subscription-reactivate", { key: '74772829f1fc17d56250cf1b133c3bc6ce8e6785', subscription: this.subscription, open: this.resubscribeModal, onScRequestClose: () => (this.resubscribeModal = false), onScRefresh: () => this.getSubscription() })));
    }
