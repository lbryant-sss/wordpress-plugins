...
const ScRichText = class {
    ...
    render() {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        return (h(Host, { key: '52cc191f19694390e9c427100a5c5549f10c1532' }, h("sc-form-control", { key: 'b553c40f23a9940472f22aa96a8b882fe0b4dd23', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, h("div", { key: '947fb4976d0f2a72d7266f9f0be9e8ee1777f38e', part: "base", class: { 'editor-base': true, 'editor--focused': this.hasFocus } }, h("div", { key: '53514e4c00612f78fc2349ee1b1bf29cb62f0333', class: "menu" }, h("sc-button", { key: '5b0302ac08d87d3a2bdc03d325e948abbbcdc95c', size: "small", type: ((_b = (_a = this.editor) === null || _a === void 0 ? void 0 : _a.isActive) === null || _b === void 0 ? void 0 : _b.call(_a, 'bold')) ? 'default' : 'text', onClick: () => this.run('toggleBold'), disabled: !this.can('toggleBold') }, h("sc-icon", { key: '2cce80c5978c7769718d598be8b7f6faf066ce56', name: "bold" })), h("sc-button", { key: '0843e568734eb641805975e7cdbb44aeab794588', size: "small", type: ((_d = (_c = this.editor) === null || _c === void 0 ? void 0 : _c.isActive) === null || _d === void 0 ? void 0 : _d.call(_c, 'italic')) ? 'default' : 'text', onClick: () => this.run('toggleItalic'), disabled: !this.can('toggleItalic') }, h("sc-icon", { key: '92dd14381a00b317f48663a9c628c598d75a8c26', name: "italic" })), h("sc-button", { key: 'eb7c0a72ad8261aec9c417624c96625ecbd7980c', size: "small", type: ((_f = (_e = this.editor) === null || _e === void 0 ? void 0 : _e.isActive) === null || _f === void 0 ? void 0 : _f.call(_e, 'bulletList')) ? 'default' : 'text', onClick: () => this.run('toggleBulletList') }, h("sc-icon", { key: 'bf70f28880746c0744e2135e7be170c5b4975668', name: "list" })), h("sc-button", { key: 'e1eacd3f2286672b3b8a3e92959a99b7e55f995b', size: "small", type: ((_h = (_g = this.editor) === null || _g === void 0 ? void 0 : _g.isActive) === null || _h === void 0 ? void 0 : _h.call(_g, 'strike')) ? 'default' : 'text', onClick: () => this.run('toggleStrike') }, h("sc-icon", { key: '1247eb284cda07394bff161bf5ee192839826bbd', name: "minus" })), h("sc-button", { key: 'c2e762db9f8de7ec11322368d0dc34a9282874fb', class: "right", size: "small", type: "text", onClick: () => this.run('undo'), disabled: !this.can('undo') }, h("sc-icon", { key: '692ad5edc231ec963cf6133c15101de6d8a7098c', name: "corner-up-left" })), h("sc-button", { key: '7b43a1b8eb852675875f9aa25b31510f09a2c323', size: "small", type: "text", onClick: () => this.run('redo'), disabled: !this.can('redo') }, h("sc-icon", { key: 'ff828f80f804ef8a44d9cd497a09e77bb493f532', name: "corner-up-right" }))), h("div", { key: '08429fdd0930e209d2eb1fe52d0ccc7ed102dbbe', part: "editor", class: {
                editor: true,
            }, ref: el => (this.element = el) })), this.remainingCharacters() < 20 && h("div", { key: 'b4238ed38a47894154e0866d4c73eb0f39e654f2', class: 'textarea__char-limit-warning' }, wp.i18n.sprintf(wp.i18n.__('%d characters remaining', 'surecart'), this.remainingCharacters())))));
    }
};
