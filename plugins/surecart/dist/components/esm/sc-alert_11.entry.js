...
const ScBlockUi = class {
    ...
    render() {
        return (h("div", { key: 'dd58679ef3289448e80d7f131bfb373feff9867b', part: "base", class: { overlay: true, transparent: this.transparent }, style: { 'z-index': this.zIndex.toString() } }, h("div", { key: '0ea42adf2a5f8952c01c464dc80b9177086c4240', class: "overlay__content", part: "content" }, h("slot", { key: '341a0c75b8b55288cfe0198ba69d568c0320eb49', name: "spinner" }, !this.transparent && this.spinner && h("sc-spinner", { key: 'ecaaa1049ca7b31e4426e9dfb519c3ddb6fffa40' })), h("slot", { key: '6a1b196acb76b8385bdc7d68621a155536bc6da3' }))));
    }
};
...
const ScButton = class {
    ...
    render() {
        ...
        const interior = (h(Fragment, { key: '1e8429a9a2fca3cfc72aceed39fd5dc7cf4783de' }, h("span", { key: 'f3d28acb0e040d1987b02fc71f24b70a1e640dd6', part: "prefix", class: "button__prefix" }, h("slot", { key: '1d6522d8a68a0022d2ddb4166fea0ca061334950', onSlotchange: () => this.handleSlotChange(), name: "prefix" })), h("span", { key: '19074f85f8e45401f841ca28fbf15c24ec59f0b2', part: "label", class: "button__label" }, h("slot", { key: '65c470b7d8ca0c04015641a802a0923a7d7731d2', onSlotchange: () => this.handleSlotChange() })), h("span", { key: '90ee2e8292e62a4a8227518c3de7b9a2e8e3d81a', part: "suffix", class: "button__suffix" }, h("slot", { key: 'bb0d90ec009da2ddb0adf38383f3cdeefa50d43f', onSlotchange: () => this.handleSlotChange(), name: "suffix" })), this.caret ? (h("span", { part: "caret", class: "button__caret" }, h("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }, h("polyline", { points: "6 9 12 15 18 9" })))) : (''), this.loading || this.busy ? h("sc-spinner", { exportparts: "base:spinner" }) : ''));
        return (h(Tag, { key: 'eae11aa3d4970d7d25f053b824a8b6727a4089cc', part: "base", class: {
                'button': true,
...
const ScDialog = class {
    ...
    render() {
        return (h("div", { key: '65ff387f1ac176f9d169ee461649b03e6684d498', part: "base", ref: el => (this.dialog = el), class: {
                'dialog': true,
                'dialog--open': this.open,
                'dialog--has-footer': this.hasFooter,
            }, onKeyDown: e => this.handleKeyDown(e) }, h("div", { key: '9e6b1e5fcac0fd9b0ca400d567dae390082cbf02', part: "overlay", class: "dialog__overlay", onClick: e => {
                e.preventDefault();
                e.stopImmediatePropagation();
                this.requestClose('overlay');
            }, ref: el => (this.overlay = el), tabindex: "-1" }), h("div", { key: 'ff10efedebccd302903e95029011bc16973df218', part: "panel", class: "dialog__panel", role: "dialog", "aria-modal": "true", "aria-hidden": this.open ? 'false' : 'true', "aria-label": this.noHeader || this.label, "aria-labelledby": !this.noHeader || 'title', ref: el => (this.panel = el), tabindex: "0" }, !this.noHeader && (h("header", { key: '28eda74f6416ae8d14f08b6ae3a3892035b0d928', part: "header", class: "dialog__header" }, h("h2", { key: '5f9b547968b3b85ad3bcd3fef72d33648d7853df', part: "title", class: "dialog__title", id: "title" }, h("slot", { key: 'cc6b5025baefa27b59ab3a409ec23d0bf7bb145e', name: "label" }, " ", this.label.length > 0 ? this.label : String.fromCharCode(65279), " ")), h("sc-button", { key: '2e624fcc0caaca22ac23474df230dc4d9c8cbcc8', class: "dialog__close", type: "text", circle: true, part: "close-button", exportparts: "base:close-button__base", onClick: e => {
                e.preventDefault();
                e.stopImmediatePropagation();
                this.requestClose('close-button');
            } }, h("sc-icon", { key: '57190eaf4fa500e35ea51f6069341733e6361b02', name: "x", label: wp.i18n.__('Close', 'surecart') })))), h("div", { key: '34c2db192ae46a24436968665912ab50fe85a4be', part: "body", class: "dialog__body" }, h("slot", { key: '18ff72f8156560d8bfa3e7903122ae519fbd5227' })), h("footer", { key: 'd5ec6921a4ca8a7cd54f71c4298aaff0ea6bec27', part: "footer", class: "dialog__footer" }, h("slot", { key: '09b7dd0ffd0b4099448d8d9a061e57fb0831481d', name: "footer" })))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
        "open": ["handleOpenChange"]
...
const ScSkeleton = class {
    ...
    render() {
        return (h("div", { key: 'b4a3a956646dbde3f2cde6510eb0e17dd292b198', part: "base", class: {
                'skeleton': true,
                'skeleton--pulse': this.effect === 'pulse',
                'skeleton--sheen': this.effect === 'sheen',
            }, "aria-busy": "true", "aria-live": "polite" }, h("div", { key: 'b33a08d5851eac3c041a2e479b0d743c8558612b', part: "indicator", class: "skeleton__indicator" })));
    }
};
...
const ScSpinner = class {
    ...
    render() {
        return h("span", { key: '7fdaa37ef50021755e5b6374a230d8202d601101', part: "base", class: "spinner", "aria-busy": "true", "aria-live": "polite" });
    }
};
...
const ScText = class {
    ...
    render() {
        ...
        return (h(CustomTag, { key: '0b88f41d994b036e8330053be700ba438d77e126', class: {
                'text': true,
                'is-truncated': this.truncate,
                'text--is-rtl': isRtl()
            } }, h("slot", { key: '0b3b27886d1d7c9ea93b810a4b6150759a7c4c4a' })));
    }
};
