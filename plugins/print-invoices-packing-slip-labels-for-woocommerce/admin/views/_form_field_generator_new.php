												...
												<tbody>
													<tr class="wf_inv_num_frmt_fw_append_btn_tr">
														<td><a class="wf_inv_num_frmt_fw_append_btn" title="' . $date_frmt_tooltip . '"
																data-format-val="[d-m-Y]">[d-m-Y]<span>' . date('d-m-Y') . '</span></a></td>
													</tr>
													<tr class="wf_inv_num_frmt_fw_append_btn_tr">
														<td><a class="wf_inv_num_frmt_fw_append_btn" title="' . $date_frmt_tooltip . '"
																data-format-val="[d/m/y]">[d/m/y]<span>' . date('d/m/y') . '</span></a></td>
													...
													<tr class="wf_inv_num_frmt_fw_append_btn_tr">
														<td><a class="wf_inv_num_frmt_fw_append_btn" title="' . $date_frmt_tooltip . '"
																data-format-val="[d]">[d]<span>' . date('d') . '</span></a></td>
													...
													<tr class="wf_inv_num_frmt_fw_append_btn_tr">
														<td><a class="wf_inv_num_frmt_fw_append_btn" title="' . $date_frmt_tooltip . '"
																data-format-val="[m]">[m]<span>' . date('m') . '</span></a></td>
													...
													<tr class="wf_inv_num_frmt_fw_append_btn_tr">
														<td><a class="wf_inv_num_frmt_fw_append_btn" title="' . $date_frmt_tooltip . '"
																data-format-val="[y]">[y]<span>' . date('y') . '</span></a></td>
													...
													<tr class="wf_inv_num_frmt_fw_append_btn_tr">
														<td><a class="wf_inv_num_frmt_fw_append_btn" title="' . $date_frmt_tooltip . '"
																data-format-val="[F]">[F]<span>' . date('F') . '</span></a></td>

													</tr>
													<tr class="wf_inv_num_frmt_fw_append_btn_tr">
														<td><a class="wf_inv_num_frmt_fw_append_btn" title="' . $date_frmt_tooltip . '"
																data-format-val="[dS]">[dS]<span>' . date('dS') . '</span></a></td>
