...
class OrderCreatedTrigger extends BaseTrigger
{
    public function __construct()
    {
        $this->triggerName = 'fluent_cart/order_paid';
        $this->priority = 20;
        $this->actionArgNum = 1;
        parent::__construct();
    }
    ...
    public function getTrigger()
    {
        return [
            ...
            'label' => __('New Order (Success)', 'fluent-crm'),
    ...
    {
        return [
            'title' => __('New Order (Success)', 'fluent-crm'),
            'sub_title' => __('This will start when an order is created', 'fluent-crm'),
            'fields' => [
                'subscription_status' => [
