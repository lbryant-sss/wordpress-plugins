        ...
        <td style="position:relative;overflow:hidden;">
			...
			<fieldset >
				...
				<label for="ahsc_debug_status" style="display: inline-block;position:relative;" >
                    <span style="float:left;height: 34px;margin-top:17px;">
                        <strong>
                        <?php
            ...
            <div>
                <a id="cdn-panel-admin" class="button button-secondary" href="#" target="_blank" style="font-weight: bold;font-size: 14px;" ><?php echo wp_kses( __( 'ACCESS THE PANEL', 'aruba-hispeed-cache' ), array( 'strong' => array() ) )  ?> </a>
            </div>
		</td>
	</tr>
	</tbody>
