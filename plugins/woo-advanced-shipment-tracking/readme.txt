...
* **850+ shipping carriers with a predefined tracking link** - Select your preferred shipping carriers from a list of 850+ shipping carriers. The tracking link will direct your customers to track their shipment on the shipping provider website.
...
* **Custom shipping carriers** - Create custom shipping carriers with a custom tracking link
* **White Label the shipping carriers** - Update the display name and logo of predefined shipping carriers
* **Auto-detect shipping carriers** - auto-detect the shipping carriers when adding the tracking number to orders (manually only)
* **Automated CSV Import through FTP/SFTP ** - Automate the process of importing tracking information from CSV files by connecting your WooCommerce store to an FTP or SFTP server. AST Pro allows you to schedule regular imports, ensuring your orders are always updated with the latest tracking details without manual intervention. This feature is ideal for stores working with warehouses or dropshippers who provide tracking data in CSV format.
...
Check out the complete list of [shipping carriers](https://docs.zorem.com/docs/ast-free/shipping-carriers/#shipping-carriers-list-options/)
