                        ...
                        <div class="row b2s-user-settings-area">
                            ...
                            <div class="tab-content clearfix">
                                ...
                                <div class="tab-pane" id="b2s-times">
                                    ...
                                    <br>
                                    <p><?php echo wp_kses(sprintf(__('You will find more information about the pre-defined best time settings by Blog2Social in this <a href="%s" target="_blank">best time guide</a>.', 'blog2social'), esc_url(B2S_Tools::getSupportLink('besttimes_blogpost'))),
                                        array('a' => array('href' => array(), 'target' => array()))); ?></p>
                                    <br>
                                    <p><?php echo wp_kses(sprintf(__('An instruction on how to define your own best times is explained in the guide "<a href="%s" target="_blank">How do I set my own time setting to post on social media?</a>".', 'blog2social'), esc_url(B2S_Tools::getSupportLink('besttimes_faq'))),
                                ...
                                <div class="tab-pane" id="b2s-templates">
                                    ...
                                    <p><?php echo wp_kses(sprintf(__('You will find more information on how to use post templates for your social media posts in this <a href="%s" target="_blank">post template guide</a>.', 'blog2social'), esc_url(B2S_Tools::getSupportLink('template_faq'))),
                                        array('a' => array('href' => array(), 'target' => array())));
                                    ?></p>
                                    <br>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <br><br>
                <?php echo wp_kses(sprintf(__('<a href="%s" target="_blank">Learn more about it here.</a>', 'blog2social'), esc_url(B2S_Tools::getSupportLink('custom_permalinks'))),
                    array('a' => array('href' => array(), 'target' => array())));
                ?>
            </div>
        </div>
