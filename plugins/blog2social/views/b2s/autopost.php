...
<div class="modal fade" id="b2sAutoPostBestTimesInfoModal" tabindex="-1" role="dialog" aria-labelledby="b2sAutoPostBestTimesInfoModal" aria-hidden="true" data-backdrop="false"  style="display:none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo sprintf(wp_kses(__('The time of publishing a post can play a decisive role in achieving more likes, shares and comments as well as a wide reach. Each social media network has it\'s "best times". Blog2Social provides you with predefined best times. When you activate the "best times" for your Auto-Poster, your WordPress posts and pages will be shared automatically at the "best times". Get more information about the "best times" in the guide "<a href="%s" target="_blank">The Best Times to Post on Social Media</a>".', 'blog2social'), 
                    array(
                        'a' => array(
                            'href' => array(), 
                            'target' => array())
                ...
                <br>
                <br>
                <?php echo sprintf(wp_kses(__('Please note: You can also set up your own "best times". You will learn how to set up your own "best times" in this <a href="%s" target="_blank">guide</a>.', 'blog2social'),
                    array('a' => array(
                            'href' => array(), 
                            'target' => array())
                        )),
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <br>
                <br>
                <?php echo sprintf(wp_kses(__('<a href="%s" target="_blank">How to set up the Auto-Poster for your own WordPress content</a>', 'blog2social'),
                    array('a' => array(
                        'href' => array(), 
                        'target' => array())
                    )), 
                ...
                <br>
                <?php echo sprintf(wp_kses(__('<a href="%s" target="_blank">Sharing with the Auto-Poster- Things to check for Troubleshooting</a>', 'blog2social'), 
                    array('a' => array(
                        'href' => array(), 
                        'target' => array())
                    )),
                ...
                <br>
                <?php echo sprintf(wp_kses(__('1. is activated with a valid Blog2Social Premium license (<a href="%s" target="_blank">How do I activate my license key?</a>)', 'blog2social'), 
                    array('a' => array(
                        'href' => array(), 
                        'target' => array())
                    )),
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <br>
                <br>
                <?php echo sprintf(wp_kses(__('<a href="%s" target="_blank">How to set up the Auto-Poster for imported content</a>', 'blog2social'),
                    array('a' => array(
                        'href' => array(), 
                        'target' => array())
                    )),
                ...
                <br>
                <?php echo sprintf(wp_kses(__('<a href="%s" target="_blank">Sharing imported posts with the Auto-Poster- Things to check for Troubleshooting</a>', 'blog2social'), 
                    array('a' => array(
                        'href' => array(), 
                        'target' => array())
                    )),
