                        ...
                        <div class="b2s-metrics-area" style="display:none">
                            ...
                            <div class="b2s-sort-area">
                                ...
                                <div class="b2s-activity-search-content pull-right">
                                    <input class="form-control" id="b2s-metrics-date-picker" value="<?php echo (substr(B2S_LANGUAGE, 0, 2) == 'de') ? esc_attr(date('d.m.Y', strtotime("-1 week"))) : esc_attr(date('Y-m-d', strtotime("-1 week"))); ?>" data-language='<?php echo (substr(B2S_LANGUAGE, 0, 2) == 'de' ? 'de' : 'en'); ?>' />
                                </div>
                                <br>
