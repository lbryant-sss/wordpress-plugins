            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><?php
                        ...
                        echo ' ' . wp_kses(sprintf(__('<a target="_blank" href="%s">Learn how to set up auto posting for your blog posts</a>', 'blog2social'), esc_url(B2S_Tools::getSupportLink('auto_poster_m'))),
                            array(
                                'a' => array(
                                    'href' => array(),
                                    'target' => array())
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><?php
                        ...
                        echo ' ' . wp_kses(sprintf(__('<a target="_blank" href="%s">Learn how to set up auto posting for imported posts</a>', 'blog2social'), esc_url(B2S_Tools::getSupportLink('auto_poster_a'))),
                            array(
                                'a' => array(
                                    'href' => array(),
                                    'target' => array()
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <br>
                    <?php echo wp_kses(sprintf(__('You will get more information on how to assign the Auto-Poster settings in the <a target="_blank" href="%s">Auto-Poster guide</a>.', 'blog2social'), esc_url(B2S_Tools::getSupportLink('auto_post_assign'))),
                        array(
                            'a' => array(
                                'href' => array(),
                                'target' => array()
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><?php
                        ...
                        echo ' ' . wp_kses(sprintf(__('<a target="_blank" href="%s">More information</a>', 'blog2social'), esc_url(B2S_Tools::getSupportLink('re_post'))),
                            array(
                                'a' => array(
                                    'href' => array(),
                                    'target' => array()
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="meta-body modal-meta-content" data-meta-type="og" data-meta-origin="ship" style="display: none;">
                    ...
                    <br>
                    <br>
                    <?php echo wp_kses(sprintf(__('Your changes will not be applied to your previously shared social media posts if you have manually disabled the meta tag options in your <a target="_blank" href="%s">Blog2Social settings</a>.', 'blog2social'), esc_url('admin.php?page=blog2social-settings')),
                        array('a' => 
                            array('target' => array(), 
                            'href' => array())
                            )
                    ...
                    <br>
                    <br>
                    <?php echo wp_kses(sprintf(__('For more information on how to set meta tags correctly, you can take a look into the <a target="_blank" href="%s">meta tag checklist</a>.', 'blog2social'), esc_url(B2S_Tools::getSupportLink('yoast_warning_og_guide'))),
                        array('a' => 
                            array('target' => array(), 
                            'href' => array())
                            )
                ...
                <div class="meta-body modal-meta-content" data-meta-type="card" data-meta-origin="ship" style="display: none;">
                    ...
                    <br>
                    <br>
                    <?php echo wp_kses(sprintf(__('Your changes will not affect your previously shared social media posts if you have manually disabled the meta tag options in your <a target="_blank" href="%s">Blog2Social settings</a>.', 'blog2social'), esc_url('admin.php?page=blog2social-settings')),
                        array('a' => 
                            array('target' => array(), 
                            'href' => array())
                            )
                    ...
                    <br>
                    <br>
                    <?php echo wp_kses(sprintf(__('For more information on how to set meta tags correctly, you can take a look into the <a target="_blank" href="%s">Twitter Card guide</a>.', 'blog2social'), esc_url(B2S_Tools::getSupportLink('twitter_card_guide'))),
                        array('a' => 
                            array('target' => array(), 
                            'href' => array())
                            )
                ...
                <?php if (B2S_PLUGIN_USER_VERSION == 0) {
                    ...
                    <br>
                    <center>
                        <?php echo wp_kses(sprintf(__('or <a target="_blank" href="%s">start with free 30-days-trial of Blog2Social Premium</a> (no payment information needed)', 'blog2social'), esc_url('https://service.blog2social.com/trial')),
                            array('a' => 
                                array('target' => array(), 
                                'href' => array())
                                )
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="isOgMetaChecked meta-text" style="display:none;">
                    <?php echo wp_kses(sprintf(__('Your changes will have no effect on your social media posts on Facebook, if you have manually unchecked the Meta Tag options for Facebook in your Blog2Social <a target="_blank" href="%s">settings</a>', 'blog2social'), esc_url('admin.php?page=blog2social-settings')),
                        array('a' => 
                            array('target' => array(), 
                            'href' => array())
                            )
                ...
                <div class="isCardMetaChecked meta-text"  style="display:none;">
                    <?php echo wp_kses(sprintf(__('Your changes will have no effect on your social media posts on Twitter, if you have manually unchecked the Meta Tag options for Twitter in your Blog2Social <a target="_blank" href="%s">settings</a>', 'blog2social'), esc_url('admin.php?page=blog2social-settings')),
                        array('a' => 
                            array('target' => array(), 
                            'href' => array())
                            )
