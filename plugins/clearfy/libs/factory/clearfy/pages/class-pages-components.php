...
class Components extends \Wbcr_FactoryClearfy246_PageBase {
	...
	public function showPageContent()
	{
		...
		<div class="wbcr-factory-page-group-header"><?php _e('<strong>Plugin Components</strong>.', 'wbcr_factory_clearfy_246') ?>
			<p>
				<?php _e('These are components of the plugin bundle. When you activate the plugin, all the components turned on by default. If you don’t need some function, you can easily turn it off on this page.', 'wbcr_factory_clearfy_246') ?>
			</p>
		</div>
