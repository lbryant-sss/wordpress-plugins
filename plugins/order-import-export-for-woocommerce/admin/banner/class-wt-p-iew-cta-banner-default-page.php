...
if ( ! class_exists('WT_P_IEW_CTA_Banner_Default_Page') ) {
    class WT_P_IEW_CTA_Banner_Default_Page
    {
        ...
        public function product_cta_banner_in_default_page() {
            ...
            $text = __( 'Product Import Export Plugin for WooCommerce.', 'order-import-export-for-woocommerce' );
            $did_you_know = __( 'Did You Know?', 'order-import-export-for-woocommerce' );
            $get_text = __( 'Get', 'order-import-export-for-woocommerce' );

            // Set appropriate message based on page type
            if ( $is_import_page ) {
                $main_text = __( 'Go beyond basic CSV imports. Effortlessly import products from CSV, XML, or Excel, make bulk edits, and schedule imports on your terms with the Product Import plugin.', 'order-import-export-for-woocommerce' );
                    ...
                    var banner = `
                        ...
                        ">
                            ...
                            <button type="button" class="wt-product-cta-close" style="
                                ...
                                line-height: 1;
                            " title="<?php esc_attr_e( 'Close', 'order-import-export-for-woocommerce' ); ?>">×</button>
