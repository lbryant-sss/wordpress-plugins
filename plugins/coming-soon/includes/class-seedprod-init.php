...
class SeedProd_Lite_Init {
	...
	private function load_dependencies() {
		 ...
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-seedprod-loader.php';

		/**
		 * The class responsible for defining all actions in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-seedprod-admin.php';

		/**
		 * Load utility functions that contain the welcome redirect
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/includes/utility-functions.php';
