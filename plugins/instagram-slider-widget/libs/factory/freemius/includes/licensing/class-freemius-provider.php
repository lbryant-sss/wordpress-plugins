...
namespace WBCR\Factory_Freemius_171\Premium;

use WBCR\Factory_Freemius_171\Entities\License;
use WBCR\Factory_Freemius_171\Entities\Plugin;
use WBCR\Factory_Freemius_171\Entities\Site;
use WBCR\Factory_Freemius_171\Entities\User;
use WBCR\Factory_481\Premium\Provider as License_Provider;
use Wbcr_Factory481_Plugin;
use WBCR\Factory_Freemius_171\Api;
use WP_Error;
use Exception;
...
final class Provider extends License_Provider {
	...
	/**
	 * @var \WBCR\Factory_Freemius_171\Api
	 */
	private $site_api;
	 ...
	 * @throws Exception
	 */
	public function __construct(Wbcr_Factory481_Plugin $plugin, array $settings)
	{
	...
	/**
	 * @return \WBCR\Factory_Freemius_171\Entities\License|null
	 * @throws Exception
	 */
	 ...
	 * @param bool $flush
	 *
	 * @return \WBCR\Factory_Freemius_171\Api
	 * @throws Exception
	 */
