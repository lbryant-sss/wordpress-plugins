...
namespace WBCR\Factory_Freemius_168\Premium;

use WBCR\Factory_Freemius_168\Entities\License;
use WBCR\Factory_Freemius_168\Entities\Plugin;
use WBCR\Factory_Freemius_168\Entities\Site;
use WBCR\Factory_Freemius_168\Entities\User;
use WBCR\Factory_478\Premium\Provider as License_Provider;
use Wbcr_Factory478_Plugin;
use WBCR\Factory_Freemius_168\Api;
use WP_Error;
use Exception;
...
final class Provider extends License_Provider {
	...
	/**
	 * @var \WBCR\Factory_Freemius_168\Api
	 */
	private $site_api;
	 ...
	 * @throws Exception
	 */
	public function __construct(Wbcr_Factory478_Plugin $plugin, array $settings)
	{
	...
	/**
	 * @return \WBCR\Factory_Freemius_168\Entities\License|null
	 * @throws Exception
	 */
	 ...
	 * @param bool $flush
	 *
	 * @return \WBCR\Factory_Freemius_168\Api
	 * @throws Exception
	 */
