...
class Upgrader {
	 ...
	 * [
	 *  'wordpress' => 'WBCR\Factory_Freemius_171\Updates\Freemius_Repository',
	 *  'freemius' => '\WBCR\Factory_481\Updates\Wordpress_Repository'
	 * ]
	 */
	...
	public function __construct(Wbcr_Factory481_Plugin $plugin)
	{
		...
		self::$repositories['wordpress'] = '\WBCR\Factory_481\Updates\Wordpress_Repository';
		self::$repositories['github'] = '\WBCR\Factory_481\Updates\Github_Repository';
	...
	protected function get_repository($repository_name)
	{
		...
		if( isset(self::$repositories[$repository_name]) && class_exists(self::$repositories[$repository_name]) ) {
			if( self::$repositories[$repository_name] instanceof Repository ) {
				throw new Exception("Repository {$repository_name} must extend the class WBCR\Factory_481\Updates\Repository interface!");
			}
