 ...
 * @version       1.0
 */
class Wbcr_FactoryLogger145_PageBase extends \WBCR\Factory_Templates_131\Pages\PageBase {
	...
	public function __construct($plugin)
	{
		...
		$this->page_menu_short_description = __('Plugin debug report', 'wbcr_factory_logger_145');
	...
	public function assets($scripts, $styles)
	{
		...
		$this->scripts->localize('wbcr_factory_logger_145', [
		...
		$buttons = "
            <div class='btn-group'>
                ...
                <a href='#'
                   ...
                   data-working='" . __('Working...', 'wbcr_factory_logger_145') . "'>" . sprintf(__('Clean-up Logs (<span id="wbcr-log-size">%s</span>)', 'wbcr_factory_logger_145'), $this->get_log_size_formatted()) . "
                   </a>
            </div>";
		?>
		<div class="wbcr-factory-page-group-header" style="margin-top:0;">
			<strong><?php _e('Plugin Log', 'wbcr_factory_logger_145') ?></strong>
			<p>
