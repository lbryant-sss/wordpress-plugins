function wbcr_factory_logger_145_LogCleanup(element) {
    ...
    jQuery.ajax({
        ...
        method: 'post',
        data: {
            action: 'wbcr_factory_logger_145_'+wbcr_factory_logger_145.plugin_prefix+'logs_cleanup',
            nonce: wbcr_factory_logger_145.clean_logs_nonce
        },
        success: function (data) {
            ...
            jQuery.wbcr_factory_templates_131.app.showNotice(data.message, data.type);
        },
        error: function (jqXHR, textStatus, errorThrown) {
            jQuery.wbcr_factory_templates_131.app.showNotice('Error: ' + errorThrown + ', status: ' + textStatus, 'danger');
            btn.html(currentBtnText);
        }
    });
}
