<?php
	...
	if( !class_exists('Wbcr_FactoryForms478_Bootstrap3FormLayout') ) {
		/**
		 * A form layout based on Twitter Bootstrap 3
		 */
		class Wbcr_FactoryForms478_Bootstrap3FormLayout extends Wbcr_FactoryForms478_FormLayout {
			...
			/**
			 * @param Wbcr_FactoryForms478_Control $control
			 */
