<?php
	...
	if( !class_exists('Wbcr_FactoryForms481_Bootstrap3FormLayout') ) {
		/**
		 * A form layout based on Twitter Bootstrap 3
		 */
		class Wbcr_FactoryForms481_Bootstrap3FormLayout extends Wbcr_FactoryForms481_FormLayout {
			...
			/**
			 * @param Wbcr_FactoryForms481_Control $control
			 */
