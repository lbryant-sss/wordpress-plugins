<?php
	...
	if( !class_exists('Wbcr_FactoryForms481_ColorAndOpacityControl') ) {
	}

	class Wbcr_FactoryForms481_ColorAndOpacityControl extends Wbcr_FactoryForms481_ComplexControl {
		...
		public function __construct($options, $form, $provider = null)
		{
			...
			$this->opacity = new Wbcr_FactoryForms481_IntegerControl($options['opacity'], $form, $provider);
