<?php
	...
	if( !class_exists('Wbcr_FactoryForms478_ColorAndOpacityControl') ) {
	}

	class Wbcr_FactoryForms478_ColorAndOpacityControl extends Wbcr_FactoryForms478_ComplexControl {
		...
		public function __construct($options, $form, $provider = null)
		{
			...
			$this->opacity = new Wbcr_FactoryForms478_IntegerControl($options['opacity'], $form, $provider);
