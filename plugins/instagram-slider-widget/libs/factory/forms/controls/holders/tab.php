<?php
	...
	if( !class_exists('Wbcr_FactoryForms481_TabHolder') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms481_TabHolder extends Wbcr_FactoryForms481_Holder {
			 ...
			 * @param FactoryForms481_Form $form A parent form.
			 */
				...
				<div class="factory-headers">
					<ul class="nav nav-tabs">
						<?php foreach($this->elements as $element) {
							...
							$builder = new Wbcr_FactoryForms481_HtmlAttributeBuilder();
