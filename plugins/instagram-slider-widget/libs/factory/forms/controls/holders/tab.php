<?php
	...
	if( !class_exists('Wbcr_FactoryForms478_TabHolder') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms478_TabHolder extends Wbcr_FactoryForms478_Holder {
			 ...
			 * @param FactoryForms478_Form $form A parent form.
			 */
				...
				<div class="factory-headers">
					<ul class="nav nav-tabs">
						<?php foreach($this->elements as $element) {
							...
							$builder = new Wbcr_FactoryForms478_HtmlAttributeBuilder();
