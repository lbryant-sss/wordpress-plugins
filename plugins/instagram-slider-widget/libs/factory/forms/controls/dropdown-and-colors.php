<?php
	 ...
	 *  // see FactoryForms478_DropdownControl
	 * 'dropdown' => array(
	 ...
	 *    ),
	 * // see FactoryForms478_RadioColorsControl
	 * 'colors' => array(
	 *   // a callback to return items or an array of items to select
	 *   'data' => array(
	...
	if( !class_exists('Wbcr_FactoryForms478_DropdownAndColorsControl') ) {
		
		class Wbcr_FactoryForms478_DropdownAndColorsControl extends Wbcr_FactoryForms478_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->dropdown = new Wbcr_FactoryForms478_DropdownControl($options['dropdown'], $form, $provider);
				$this->colors = new Wbcr_FactoryForms478_RadioColorsControl($options['colors'], $form, $provider);
