<?php
	...
	if( !class_exists('Wbcr_FactoryForms481_OptionsValueProvider') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms481_OptionsValueProvider implements Wbcr_IFactoryForms481_ValueProvider {
