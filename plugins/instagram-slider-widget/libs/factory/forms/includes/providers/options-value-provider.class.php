<?php
	...
	if( !class_exists('Wbcr_FactoryForms478_OptionsValueProvider') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms478_OptionsValueProvider implements Wbcr_IFactoryForms478_ValueProvider {
