...
if ( ! class_exists( 'WBCR\Factory_Templates_131\ImpressiveLite' ) ) {
	/**
	 * Class Wbcr_FactoryPages478_ImpressiveLiteTemplate
	 */
	abstract class ImpressiveLite extends \WBCR\Factory_Templates_131\Pages\PageBase {
		...
		public function assets( $scripts, $styles ) {
			...
			$this->styles->add( FACTORY_TEMPLATES_131_URL . '/pages/templates/impressive-lite/assets/css/impressive-lite.page.template.css' );
		}
		...
		protected function showPageSubMenu() {
			...
			?>
            <div class="w-factory-templates-131-horizontal-menu wp-clearfix">
				<?php foreach ( (array) $page_menu as $page_screen => $page ): ?>
					...
					if ( $page_screen == $this->getResultId() ) {
						$active_tab = ' w-factory-templates-131-horizontal-menu__nav-tab-active';
					}
					?>
                    <a href="<?php echo $page['url'] ?>" id="<?php echo esc_attr( $page_screen ) ?>-tab"
                       class="w-factory-templates-131-horizontal-menu__nav-tab<?php echo esc_attr( $active_tab ) ?>">
		...
		protected function showOptions() {
            ...
            <div id="WBCR" class="wrap">
                <div class="wbcr-factory-templates-131-impressive-lite-page-template factory-bootstrap-480 factory-fontawesome-000">
                                    ...
                                    <form method="post" class="form-horizontal">
										...
										if ( $this->type == 'options' ) {
											...
											$submit_button = "<input name='{$this->plugin->getPluginName()}_save_action'
                                                   ...
                                                   value='" . __( 'Save', 'wbcr_factory_pages_478' ) . "'>";
										}
										?>
