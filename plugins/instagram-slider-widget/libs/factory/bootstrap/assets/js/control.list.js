( function( $ ){
    ...
    $.fn.factoryBootstrap483_listControl = function (option) {
    ...
    $.fn.factoryBootstrap483_listControl.Constructor = list;

    $(function(){
        $(".factory-bootstrap-483 .factory-list").factoryBootstrap483_listControl();
    });
