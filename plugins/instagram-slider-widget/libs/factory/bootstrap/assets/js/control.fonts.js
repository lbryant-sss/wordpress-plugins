...
;( function( $ ){
    ...
    $.widget( "factoryBootstrap483.fontControl", {
    ...
    $(function(){
        $.widget.bridge( "factoryBootstrap483_fontControl", $.factoryBootstrap483.fontControl );
        $(".factory-bootstrap-483 .factory-font").factoryBootstrap483_fontControl({});
    });
