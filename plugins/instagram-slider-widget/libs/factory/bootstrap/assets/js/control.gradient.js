( function( $ ){
    ...
    $.fn.factoryBootstrap483_gradientControl = function (option) {
    ...
    $.fn.factoryBootstrap483_gradientControl.Constructor = GradientControl;
    
    // GRADIENT CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-483 .factory-gradient").factoryBootstrap483_gradientControl();
    });
