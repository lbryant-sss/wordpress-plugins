( function( $ ){
    ...
    $.fn.factoryBootstrap483_integerControl = function (option) {
    ...
    $.fn.factoryBootstrap483_integerControl.Constructor = IntegerControl;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-483 .factory-integer").factoryBootstrap483_integerControl();
    });
