<?php
	...
	add_action('admin_menu', 'Wbcr_FactoryPages481::actionAdminMenu');
	add_action('network_admin_menu', 'Wbcr_FactoryPages481::actionAdminMenu');
	...
	if( !class_exists('Wbcr_FactoryPages481') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryPages481 {

			/**
			 * @var Wbcr_FactoryPages481_Page[]
			 */
			...
			public static function getPageUrl(Wbcr_Factory481_Plugin $plugin, $page_id, $args = array())
			{
				if( isset(self::$pages[$plugin->getPluginName()]) ) {
	...
	if( !function_exists('wbcr_factory_pages_481_get_page_id') ) {
		/**
		 *
		 * @param Wbcr_Factory481_Plugin $plugin
		 ...
		 * @return string
		 */
		function wbcr_factory_pages_481_get_page_id($plugin, $page_id)
		{
