<div class="wrap">
    <div class="factory-bootstrap-480 factory-fontawesome-000">
        ...
        <div id="wis-license-wrapper"
            ...
            <div class="factory-bootstrap-480 onp-page-wrap <?php echo $this->get_license_type() ?>-license-manager-content"
                 id="license-manager">
                <div>
