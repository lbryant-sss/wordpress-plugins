                ...
                <div class="onp-container">
                    <div class="license-details">
                        ...
                        <div class="license-details-block <?php echo esc_attr( $this->get_license_type() ); ?>-details-block">
                            ...
                            <h3>
								...
								<?php if ( $this->is_premium && $this->premium_has_subscription ): ?>
                                    <span style="font-size: 15px;">
                                        (<?php printf( __( 'Automatic renewal, every %s', 'instagram-slider-widget' ), esc_html( $this->get_billing_cycle_readable() ) ); ?>)
                                    </span>
								<?php endif; ?>
                            </h3>
							<?php if ( $this->is_premium ): ?>
                            ...
                            <div class="license-key-description">
                                <p><?php _e( 'Public License is a GPLv2 compatible license allowing you to change and use this version of the plugin for free. Please keep in mind this license covers only free edition of the plugin. Premium versions are distributed with other type of a license.', 'instagram-slider-widget' ); ?></p>
								<?php if ( $this->is_premium && $this->premium_has_subscription ): ?>
									...
									<?php if ( $this->is_premium ) : ?>
                                        <td class="license-param license-param-sites">
                                            <span class="license-value">
                                                ...
                                                <?php echo esc_html( $this->premium_license->get_sites_quota() ); ?>
                                            </span>
                    ...
                    <div class="license-input">
                        <form action="" method="post">
							...
							<?php else: ?>
                                <p><?php _e( 'Have a key to activate the plugin? Paste it here:', 'instagram-slider-widget' ); ?></p>
							<?php endif; ?>
