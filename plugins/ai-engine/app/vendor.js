...
`,p=e=>{const{title:t,children:n,className:r="",busy:i=!1,style:a={},contentStyle:s={},action:p,...f}=e,g=(0,u.gR)("neko-block",r);return o().createElement(h,d({className:g,style:a},f),t&&o().createElement("div",{className:"neko-block-header"},o().createElement(l.s,{h2:!0,className:"neko-block-title"},t),!!p&&o().createElement("div",{className:"neko-block-action"},p)),o().createElement(c.A,{busy:i},o().createElement("div",{className:"neko-block-content",style:s},n)))},f=e=>o().createElement(p,e);f.propTypes={title:a().string,className:a().oneOf(["","primary","standard","raw"]),style:a().object,action:a().element}},8668:(e,t,n)=>{"use strict";n.d(t,{Zc:()=>g,y2:()=>f});var r=n(1594),o=n.n(r),i=n(7639),a=n.n(i),s=n(3185);const l=s.Ay.div`
  margin-bottom: 10px;
`,c=s.Ay.div`
  margin-bottom: 0px;
  padding-bottom: 2px;
